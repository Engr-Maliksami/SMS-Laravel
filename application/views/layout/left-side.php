        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <!-- vipul start -->
			     <?php if($this->session->userdata('role_id') == SUPER_ADMIN || $this->session->userdata('role_id') == ADMIN || $this->session->userdata('role_id') == TEACHER || $this->session->userdata('role_id') == STUDENT) { ?>
				<li><a href="<?php echo site_url('learn'); ?>"><i class="fa fa-book"></i> Learning Portal</a>  </li>
				<?php } ?>
				<!-- vipul end -->
                    ...
                    <?php if(has_permission(VIEW, 'academic', 'material')){ ?>
                        ...
                        <?php }elseif($this->session->userdata('role_id') == STUDENT){ ?>
                            <li><a  href="<?php echo site_url('academic/material/index/'); ?>"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('material'); ?></a> </li>
                        <?php }else{ ?>
                            <li><a <?php if(empty($classes)){ ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('material'); ?> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <?php foreach($classes as $obj){ ?>
                                        <?php if($this->session->userdata('role_id') == GUARDIAN){ ?>
                                            <?php if (!in_array($obj->id, $guardian_class_data)) { continue; } ?>
                    ...
                    <?php if(has_permission(VIEW, 'student', 'type') ||
                        ...
                        <?php if($this->session->userdata('role_id') == TEACHER){ ?>
                            <li><a href="<?php echo site_url('student/index'); ?>"><i class="fa fa-group"></i> <?php echo $this->lang->line('student'); ?> </a></li>
                        <?php }elseif($this->session->userdata('role_id') == STUDENT){ ?>
                            <li><a href="<?php echo site_url('student/index'); ?>"><i class="fa fa-group"></i> <?php echo $this->lang->line('student'); ?> </a></li>
                                ...
                                <?php if(has_permission(VIEW, 'attendance', 'student')){ ?>
                                    <?php if($this->session->userdata('role_id') == GUARDIAN){ ?>
                                     ...
                                     <?php }else{ ?>
                                        ...
                                        <li><a href="<?php echo site_url('attendance/student/bulk'); ?>"><?php echo $this->lang->line('bulk_student_attendance'); ?></a></li>
                                     <?php } ?>
                                <?php } ?>
                        ...
                        <li><a><i class="fa fa-graduation-cap"></i> <?php echo $this->lang->line('exam'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php if(has_permission(VIEW, 'exam', 'exam')){ ?>
                                    ...
                                    <li><a href="<?php echo site_url('exam/exam_type'); ?>"><?php echo $this->lang->line('exam_type'); ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    <?php } ?>
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('exam_mark'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <?php if(has_permission(VIEW, 'exam', 'mark')){ ?>
                                    ...
                                    <li><a href="<?php echo site_url('exam/mark/bulk'); ?>"><?php echo $this->lang->line('manage_mark_bulk'); ?></a></li>
                                <?php } ?>
                    ...
                    <li><a><i class="fa fa-desktop"></i><?php echo $this->lang->line('frontend'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <?php if(has_permission(VIEW, 'frontend', 'achievement')){ ?>
                                <li><a href="<?php echo site_url('frontend/achievement/index'); ?>"> <?php echo $this->lang->line('frontend'); ?> <?php echo $this->lang->line('achievement'); ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <?php } ?>
