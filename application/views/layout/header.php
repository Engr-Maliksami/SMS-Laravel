<div class="top_nav">
    <div class="nav_menu decreaseHeight">
        <nav>
            <div class="row changeMaxHeight">
                <div class="col-md-12 col-sm-12 col-xs-12 changeMaxHeight">
                    <div class="col-md-1 col-sm-1 col-xs-1 changezindex">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-5">
                        <ul class="nav navbar-nav changeLi <?php echo $this->global_setting->enable_rtl ? 'navbar-left' : 'navbar-right'; ?>">
                            <li class="lione">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    ?>
                                    <?php if ($photo != '') { ?>
                                        <img class="changeForMobileView" src="<?php echo UPLOAD_PATH; ?>/<?php echo $path; ?>-photo/<?php echo $photo; ?>" alt="" width="60" />
                                    <?php } else { ?>
                                        <img class="changeForMobileView" src="<?php echo IMG_URL; ?>/default-user.png" alt="" width="60" />
                                    <?php } ?>
