                    ...
                    <div class="tab-content">                  
                        ...
                        <div  class="tab-pane fade in <?php if(isset($info)){ echo 'active'; }?>" id="tab_profile">
                            <div class="x_content">  
                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap hideInMobileView" cellspacing="0" width="100%">
                                    <tbody>
                                        <tr>
                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap viewInWebView" cellspacing="0" width="100%">
                                    <tbody>
                                        <tr>
                                            <th><?php echo $this->lang->line('name'); ?></th>
                                            <td><?php echo $profile->name; ?></td>
                                        ...
                                        <tr><th><?php echo $this->lang->line('permanent'); ?> <?php echo $this->lang->line('address'); ?></th>
                                            <td><?php echo $profile->permanent_address; ?></td></tr>                                                                             
                                        <tr>
                                            <th><?php echo $this->lang->line('gender'); ?></th>
                                            <td><?php echo $this->lang->line($profile->gender); ?></td>
                                        ...
                                        <tr>  <th><?php echo $this->lang->line('blood_group'); ?></th>
                                            <td><?php echo $this->lang->line($profile->blood_group); ?></td></tr>                                                                             
                                        <tr>
                                            <th><?php echo $this->lang->line('religion'); ?></th>
                                            <td><?php echo $profile->religion; ?></td>
                                        ...
                                        <tr> <th><?php echo $this->lang->line('birth_date'); ?></th>
                                            <td><?php echo date('M j,Y', strtotime($profile->dob)); ?></td></tr>                                                                              
                                        <tr>                                            
                                            <th><?php echo $this->lang->line('other_info'); ?></th>
                                            <td><?php echo $profile->other_info; ?></td>                                        
                                            
                                        </tr>  
                                        <tr><th><?php echo $this->lang->line('resume'); ?></th>
                                            <td>
                                                 <?php if($profile->resume){ ?>
                                                <a href="<?php echo UPLOAD_PATH; ?>/employee-resume/<?php echo $profile->resume; ?>"><?php echo $this->lang->line('download'); ?></a> 
                                                <?php } ?>
