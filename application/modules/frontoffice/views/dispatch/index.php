<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-tty"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('postal'); ?> <?php echo $this->lang->line('dispatch'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_dispatch_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'frontoffice', 'dispatch')){ ?>
                             <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('frontoffice/dispatch/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('dispatch'); ?></a> </li>                          
                             <?php }else{ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_dispatch"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?>  <?php echo $this->lang->line('dispatch'); ?></a> </li>                          
                             <?php } ?>
                        <?php } ?> 
                        <?php if(isset($edit)){ ?>
                            <li  class="active"><a href="#tab_edit_dispatch"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('dispatch'); ?></a> </li>                          
                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_dispatch_list" >
                            <div class="x_content">
                                ...
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_dispatch_by_school(this.value);">
                                        <option value="<?php echo site_url('frontoffice/dispatch/index/'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_dispatch">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/dispatch/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dispatch_date"><?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('date'); ?><span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="dispatch_date"  id="add_dispatch_date" value="<?php echo isset($dispatch_date) ?  date('d-m-Y', strtotime($dispatch_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="photo-details" id="attachment_filename"></div>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/dispatch/edit/'.$dispatch->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="to_title"><?php echo $this->lang->line('to'); ?> <?php echo $this->lang->line('title'); ?><span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="to_title"  id="to_title" value="<?php echo isset($dispatch) ? $dispatch->to_title : ''; ?>" placeholder="<?php echo $this->lang->line('to'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('to_title'); ?></div>
                                    </div>
                                </div>  
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="from_title"><?php echo $this->lang->line('from'); ?> <?php echo $this->lang->line('title'); ?><span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="from_title"  id="from_title" value="<?php echo isset($dispatch) ? $dispatch->from_title : ''; ?>" placeholder="<?php echo $this->lang->line('from'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('from_title'); ?></div>
                                    </div>
                                </div>  
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dispatch_date"><?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('date'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="dispatch_date"  id="edit_dispatch_date" value="<?php echo isset($dispatch) ?  date('d-m-Y', strtotime($dispatch->dispatch_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('dispatch_date'); ?></div>
                                    </div>
                                </div>  
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo $this->lang->line('postal'); ?> <?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('information'); ?></h4>
        </div>
...
<script type="text/javascript">
         ...
         $("#attachment").change(function(){
            ...
            $('#attachment_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Frontoffice",
                    text: "Postal Attachment  "+ input.files[0].name+ " selected",
                    type: "success",
