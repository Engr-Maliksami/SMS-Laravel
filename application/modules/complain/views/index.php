                        ...
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                            
                                <select  class="form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_complain_by_school(this.value,'')">
                                        <option value="<?php echo site_url('complain/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'complain', 'complain')){ ?>
                                                    <a href="<?php echo site_url('complain/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php  } ?>
                                                <?php if(has_permission(VIEW, 'complain', 'complain')){ ?>
                                                    <a  onclick="get_complain_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-complain-modal-lg"  ><i class="changeFaColor fa fa-eye"></i>  </a>
                                                <?php  } ?>
                                                <?php if(has_permission(DELETE, 'complain', 'complain')){ ?>
                                                    <a href="<?php echo site_url('complain/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php  } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('complain/edit/'.$complain->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="complain_date"  id="edit_complain_date" value="<?php echo isset($complain->complain_date) ?  date('d-m-Y',strtotime($complain->complain_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('complain'); ?> <?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('complain_date'); ?></div>
                                    </div>
                                </div>
