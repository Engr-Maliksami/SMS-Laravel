                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="form-control col-md-7 col-xs-12" onchange="get_slider_by_school(this.value);">
                                     <option value="<?php echo site_url('frontend/slider/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'frontend', 'slider')){ ?>
                                                    <a href="<?php echo site_url('frontend/slider/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php } ?>                                                
                                                <?php if(has_permission(VIEW, 'frontend', 'slider')){ ?>
                                                    <a  onclick="get_slider_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-slider-modal-lg"  ><i class="changeFaColor fa fa-eye"></i> </a>
                                                <?php  } ?>    
                                                <?php if(has_permission(DELETE, 'frontend', 'slider')){ ?>
                                                    <a href="<?php echo site_url('frontend/slider/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="text-info"><?php echo $this->lang->line('valid_file_dimension_img'); ?></div>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontend/slider/edit/'.$slider->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title"><?php echo $this->lang->line('image'); ?> <?php echo $this->lang->line('title'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($slider->title) ?  $slider->title : ''; ?>" placeholder="<?php echo $this->lang->line('image'); ?> <?php echo $this->lang->line('title'); ?>" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
...
<script type="text/javascript">
         ...
         $("#image").change(function(){
            ...
            $('#image_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Manage Slider",
                    text: "Slider Image  "+ input.files[0].name+ " selected",
                    type: "success",
