            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    ...
                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>     
                      ...
                      <!--  <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_achievement"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo 'Achievement'; ?>  </a> </li> -->
                    <?php } ?>  
                    <?php if(isset($edit)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'frontend', 'about')){ ?>
                                                    <a href="<?php echo site_url('frontend/about/edit/'.$obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'frontend', 'about')){ ?>
