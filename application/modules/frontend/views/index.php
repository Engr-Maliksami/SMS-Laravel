                    ...
                    <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_page_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('page'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="form-control col-md-7 col-xs-12" onchange="get_page_by_school(this.value);">
                                     <option value="<?php echo site_url('frontend/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'frontend', 'frontend')){ ?>
                                                    <a href="<?php echo site_url('frontend/edit/'.$obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'frontend', 'frontend')){ ?>
                                                    <a  onclick="get_frontend_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-frontend-modal-lg"  ><i class="changeFaColor fa fa-eye"></i></a>
                                                <?php  } ?> 
                                                <?php if(has_permission(DELETE, 'frontend', 'frontend')){ ?>
                                                    <a href="<?php echo site_url('frontend/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_page">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontend/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_slug"><?php echo $this->lang->line('page'); ?> url slug <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="page_slug"  id="page_slug" value="<?php echo isset($post['page_slug']) ?  $post['page_slug'] : ''; ?>" placeholder="<?php echo $this->lang->line('page'); ?> url slug" required="required" type="text" autocomplete="off">
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="photo-details" id="image_filename"></div>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontend/edit/'.$page->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="page_title"  id="page_title" value="<?php echo isset($page->page_title) ?  $page->page_title : ''; ?>" placeholder="<?php echo $this->lang->line('page'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('page_title'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_slug"><?php echo $this->lang->line('page'); ?> url slug <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="page_slug"  id="page_slug" value="<?php echo isset($page->page_slug) ?  $page->page_slug : ''; ?>" placeholder="<?php echo $this->lang->line('page'); ?> url slug" required="required" type="text" autocomplete="off">
                                        <div class="text-info">Ex: terms-and-condition. [ Must be english text ]</div>
                                        <div class="help-block"><?php echo form_error('page_slug'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_description"><?php echo $this->lang->line('page'); ?> <?php echo $this->lang->line('description'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="page_description"  id="edit_page_description" placeholder="<?php echo $this->lang->line('page'); ?> <?php echo $this->lang->line('description'); ?>"><?php echo isset($page->page_description) ?  $page->page_description : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('page_description'); ?></div>
                                    </div>
                                </div>                                                         
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo $this->lang->line('frontend'); ?> <?php echo $this->lang->line('page'); ?> <?php echo $this->lang->line('information'); ?></h4>
        </div>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
     ...
     $("#image").change(function(){
            ...
            $('#image_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Manage Frontend ",
                    text: "Image  "+ input.files[0].name+ " selected",
                    type: "success",
