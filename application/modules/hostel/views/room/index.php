                         ...
                         <li class="li-class-list">
                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_room_by_school(this.value);">
                                        <option value="<?php echo site_url('hostel/room/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'hostel', 'room')){ ?>
                                                    <a href="<?php echo site_url('hostel/room/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'hostel', 'room')){ ?>
                                                    <a  onclick="get_room_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-room-modal-lg"  ><i class="changeFaColor fa fa-eye"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'hostel', 'room')){ ?>
                                                    <a href="<?php echo site_url('hostel/room/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                               ...
                               <?php echo form_open(site_url('hostel/room/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input readonly class="form-control col-md-7 col-xs-12"  name="room_no"  id="room_no" value="<?php echo isset($post['room_no']) ?  $post['room_no'] : ''; ?>" placeholder="Auto Generated"  type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="total_seat"><?php echo $this->lang->line('no_of_bed'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="total_seat"  id="total_seat" value="<?php echo isset($post['total_seat']) ?  $post['total_seat'] : ''; ?>" placeholder="<?php echo $this->lang->line('no_of_bed'); ?>" required="required" type="number" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cost"><?php echo $this->lang->line('cost_per_bed'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="cost"  id="cost" value="<?php echo isset($post['cost']) ?  $post['cost'] : ''; ?>" placeholder="<?php echo $this->lang->line('cost_per_bed'); ?>" type="number" autocomplete="off">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('hostel/room/edit/'.$room->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input readonly  class="form-control col-md-7 col-xs-12"  name="room_no"  id="room_no" value="<?php echo isset($room->room_no) ?  $room->room_no : ''; ?>" placeholder="<?php echo $this->lang->line('room_no'); ?>"  type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('room_no'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="total_seat"  id="total_seat" value="<?php echo isset($room->total_seat) ?  $room->total_seat : ''; ?>" placeholder="<?php echo $this->lang->line('no_of_bed'); ?>" required="required" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('total_seat'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cost"><?php echo $this->lang->line('cost_per_bed'); ?>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="cost"  id="cost" value="<?php echo isset($room->cost) ?  $room->cost : ''; ?>" placeholder="<?php echo $this->lang->line('cost_per_bed'); ?>" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('cost'); ?></div>
                                    </div>
                                </div>
