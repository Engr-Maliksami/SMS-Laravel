        ...
        <div class="single-slider">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <a class="link animated glbscl-link-btn hvr-bs" href="<?php echo site_url('admission-online'); ?>"><?php echo $this->lang->line('admission'); ?> <?php echo $this->lang->line('now'); ?></a>
                </div>
            </div>
        </div>    
...
<?php if(isset($achievement) && $achievement->status == 1) { ?>
<section class="achivement-area bg-with-black">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-title text-center">
                    <h2 class="title"><?php echo $this->lang->line('our'); ?> <span class="inner"><?php echo $this->lang->line('achievement'); ?></span></h2>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
        ...
        <div class="apply-now">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                    <a href="<?php echo site_url('admission-online'); ?>" class="link glbscl-link-btn hvr-bs" style="color: #007bff !important;"><?php echo $this->lang->line('apply'); ?>  <?php echo $this->lang->line('now'); ?></a>
                </div>
            </div>
        </div>
    </div>
