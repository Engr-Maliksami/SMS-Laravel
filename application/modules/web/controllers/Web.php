...
class Web extends CI_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        if($this->session->userdata('front_school_id')){           
            ...
            $this->data['achievement'] = $this->web->get_achievement_status($school_id);
    ...
    * ********************************************************** */
    ...
    private function _prepare_admission_validation() {
        ...
        $this->form_validation->set_rules('type_id', $this->lang->line('student').' '.$this->lang->line('type'), 'trim|required');   
        ...
        $this->form_validation->set_rules('gud_email', $this->lang->line('guardian') .' '. $this->lang->line('email'), 'trim|required'); 
    ...
    * ********************************************************** */
    ...
    private function _send_email() {
        ...
        if($this->input->post('email')){
            ...
            $subject = 'Contact email from visitor of '. $this->data['school']->school_name;
            $this->email->subject($subject);       

            $message = '<strong>Contact mail from ' . $this->data['school']->school_name . '.</strong><br/>';          
            $message .= '<br/><br/>';
