                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_class_list" >
                            ...
                            <select  class="form-control col-md-7 col-xs-12" onchange="get_class_by_school(this.value);">
                                    <option value="<?php echo site_url('academic/classes/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td  class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'academic', 'classes')){ ?>
                                                    <a href="<?php echo site_url('academic/classes/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'academic', 'classes')){ ?>
                                                    <a href="<?php echo site_url('academic/classes/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                            <!-- sarvesh -->
                                        </tr>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/classes/edit/'.$class->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="numeric_name"  id="edit_numeric_name" value="<?php echo isset($class->numeric_name) ?  $class->numeric_name : ''; ?>" placeholder="<?php echo $this->lang->line('numeric'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('numeric_name'); ?></div>
                                    </div>
                                </div>
