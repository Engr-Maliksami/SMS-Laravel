                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_routine_list" >                            
                            ...
                            <?php if($this->session->userdata('role_id') != SUPER_ADMIN){  ?> 
                                ...
                                <select  class="form-control " onchange="get_subject_by_class(this.value);">
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_routine">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/routine/add'), array('onSubmit'=> 'return add_checkform()','name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_routine">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/routine/edit/'.$routine->id), array('onSubmit'=> 'return edit_checkform()','name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
    ...
    function add_checkform(){
        ...
        var end = moment.utc(timeTo, "HH:mm");
         if (end.isBefore(start) || end.isSame(start)){
            swal({
                title: "Routine",
                text: "Start Time must not greater than or equal to End Time",
                type: "error",
