                            ...
                            <?php $teacher_access_data = get_teacher_access_data('student'); ?>    
                                <?php $guardian_class_data = get_guardian_access_data('class'); ?>
                                 ...
                                 <?php }else{  ?> 
                                    ...
                                    <select  class="form-control" onchange="get_subject_list_by_class(this.value);">
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'academic', 'syllabus')){ ?>
                                                    <a href="<?php echo site_url('academic/syllabus/edit/'.$obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'academic', 'syllabus')){ ?>
                                                    <?php if($obj->syllabus){ ?>
                                                        <a href="<?php echo UPLOAD_PATH; ?>syllabus/<?php echo $obj->syllabus; ?>" target="_blank" ><i class="changeFaColor fa fa-download"></i>  </a>
                                                    <?php } ?>
                                                    <a  onclick="get_syllabus_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-syllabus-modal-lg"  ><i class="changeFaColor fa fa-eye"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'academic', 'syllabus')){ ?>
                                                    <a href="<?php echo site_url('academic/syllabus/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="btn btn-default btn-file">
                                            ...
                                            <div class="photo-details" id="syllabus_filename"></div>
...
<!-- Super admin js START  -->
 <script type="text/javascript">
     ...
     $("#syllabus").change(function(){
            ...
            $('#syllabus_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Syllabus",
                    text: "Syllabus  "+ input.files[0].name+ " selected",
                    type: "success",
