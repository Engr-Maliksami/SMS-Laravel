                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_section_list" >
                           ...
                           <?php }else{  ?> 
                            <div class="col-md-10"></div><div class="col-md-2">
                                <select  class="form-control" onchange="get_section_by_class(this.value);">
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'academic', 'section')){ ?>
                                                    <a href="<?php echo site_url('academic/section/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'academic', 'section')){ ?>
                                                    <a href="<?php echo site_url('academic/section/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
