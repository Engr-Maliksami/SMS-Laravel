<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-barcode"></i><small> <?php echo $this->lang->line('generate'); ?> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('id'); ?>  <?php echo $this->lang->line('card'); ?></small></h3>
    ...
    <div id="divContent" style="background-color: white; padding:30px; display:flex;">
                                            <div class="card-block" data-id="<?php echo $obj->user_id; ?>"> 
                                                <div class="card-top">
                                                    <div class="card-logo">
                                                ...
                                                <div class="std-id">
                                                    <h3><span><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('id'); ?>: <?php echo $obj->user_id; ?></span></h3>
                                                </div>
                                                <div class="card-main">
                                                    ...
                                                    <div class="card-info">
                                                        <p><span class="card-title"><?php //echo $this->lang->line('student'); ?>
                                                         <?php  echo $this->lang->line('name'); ?>
                                                        </span><span class="card-value">: <?php echo $obj->name; ?></span></p>
                                            ...
                                            <input type="hidden" name="pdf_name" id="pdf_name" value="<?php echo $obj->name; ?>.pdf" />
...
<script src="<?php echo JS_URL; ?>jspdf.debug.js"></script>
