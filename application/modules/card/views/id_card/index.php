                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                ...
                                                <?php if(has_permission(EDIT, 'card', 'idsetting')){ ?>
                                                    <a href="<?php echo site_url('card/idsetting/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-edit"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'card', 'idsetting')){ ?>
                                                    <a href="<?php echo site_url('card/idsetting/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
