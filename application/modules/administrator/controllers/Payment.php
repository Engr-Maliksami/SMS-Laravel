...
class Payment extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_payment_setting_validation() {
        ...
        $this->form_validation->set_rules('stack_secret_key', $this->lang->line('pay_stack') . ' ' . $this->lang->line('secret_key'), 'trim');
        $this->form_validation->set_rules('stack_public_key', $this->lang->line('pay_stack') . ' ' . $this->lang->line('public_key'), 'trim');
    ...
    * ********************************************************** */
    ...
    private function _get_posted_payment_setting_data() {
        ...
        $items[] = 'pesapal_consumer_key';
        $items[] = 'pesapal_consumer_secret';
        $items[] = 'pesapal_demo';
        $items[] = 'pesapal_extracharge';
        $items[] = 'pesapal_status';
