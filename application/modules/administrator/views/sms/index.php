                            ...
                            <table id="datatable-responsive" class="table table-striped  dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('siltech_sms'); ?></th>
                                ...
                                <tbody>
                                    <?php $count = 1; if(isset($sms_settings) && !empty($sms_settings)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->siltech_status ? $this->lang->line('yes') : $this->lang->line('no') ; ?></td>
                                            <td class="displayOneLine">

                                                <?php if(has_permission(VIEW, 'administrator', 'sms')){ ?>
                                                    <a  onclick="get_sms_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-sms-modal-lg" ><i class="changeFaColor fa fa-eye"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(EDIT, 'administrator', 'sms')){ ?>
                                                    <a href="<?php echo site_url('administrator/sms/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'administrator', 'sms')){ ?>
                                                    <a href="<?php echo site_url('administrator/sms/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <ul class="nav nav-tabs tabs-left">
                                            ...
                                            <li  class=""><a href="#tab_siltech_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('siltech_sms'); ?> <?php echo $this->lang->line('setting'); ?></a> </li>
                                        </ul>
                                      </div>
                                    <div class="col-xs-9">
                                        <div class="tab-content">
                                            ...
                                            <!-- siltech sms -->
                                            <div class="tab-pane fade in " id="tab_siltech_setting">

                                              <div class="item form-group">
                                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="siltech_sender_id"><?php echo $this->lang->line('sender_id'); ?> <span class="required">*</span></label>
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                                      <input  class="form-control col-md-7 col-xs-12"  name="siltech_sender_id" value="<?php echo isset($sms_setting) ? $sms_setting->siltech_sender_id : ''; ?>"  placeholder="<?php echo $this->lang->line('sender_id'); ?>" required="required" type="text" autocomplete="off">
                                                      <div class="help-block"><?php echo form_error('siltech_sender_id'); ?></div>
                                                  </div>
                                              </div>

                                              <div class="item form-group">
                                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="siltech_campaign_id"><?php echo $this->lang->line('campaign_id'); ?> <span class="required">*</span></label>
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                                      <input  class="form-control col-md-7 col-xs-12"  name="siltech_campaign_id" value="<?php echo isset($sms_setting) ? $sms_setting->siltech_campaign_id : ''; ?>"  placeholder="<?php echo $this->lang->line('campaign_id'); ?>" required="required" type="text" autocomplete="off">
                                                      <div class="help-block"><?php echo form_error('siltech_campaign_id'); ?></div>
                                                  </div>
                                              </div>

                                              <div class="item form-group">
                                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="siltech_route_id"><?php echo $this->lang->line('route_id'); ?> <span class="required">*</span></label>
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                                      <input  class="form-control col-md-7 col-xs-12"  name="siltech_route_id" value="<?php echo isset($sms_setting) ? $sms_setting->siltech_route_id : ''; ?>"  placeholder="<?php echo $this->lang->line('route_id'); ?>" required="required" type="text" autocomplete="off">
                                                      <div class="help-block"><?php echo form_error('siltech_route_id'); ?></div>
                                                  </div>
                                              </div>

                                               <div class="item form-group">
                                                   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="siltech_api_key"><?php echo $this->lang->line('api_key'); ?> <span class="required">*</span></label>
                                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                                       <input  class="form-control col-md-7 col-xs-12"  name="siltech_api_key" value="<?php echo isset($sms_setting) ? $sms_setting->siltech_api_key : ''; ?>"  placeholder="<?php echo $this->lang->line('api_key'); ?>" required="required" type="text" autocomplete="off">
                                                       <div class="help-block"><?php echo form_error('siltech_api_key'); ?></div>
                                                   </div>
                                               </div>


                                               <div class="item form-group">
                                                   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="siltech_status"><?php echo $this->lang->line('is_active'); ?> <span class="required">*</span></label>
                                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                                       <select  class="form-control col-md-7 col-xs-12"  name="siltech_status" required="required">
                                                           <option value="0" <?php if(isset($sms_setting) && $sms_setting->siltech_status == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                                           <option value="1" <?php if(isset($sms_setting) && $sms_setting->siltech_status == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                                       </select>
                                                       <div class="help-block"><?php echo form_error('siltech_status'); ?></div>
                                                   </div>
                                               </div>
                                              <div class="item form-group">
                                                   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">&nbsp;</label>
                                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                                       <a href="https://siltechtz.com/" target="_blank"><img src="<?php echo IMG_URL; ?>siltech-logo.png" alt="" /></a>
                                                        <div class="instructions">Tanzania SMS Gateway</div>
                                                   </div>
                                               </div>
                                           </div>
                                            <!-- siltechtz sms end -->
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <ul class="nav nav-tabs tabs-left">
                                            ...
                                            <li  class=""><a href="#tab_edit_siltech_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('siltech_sms'); ?> <?php echo $this->lang->line('setting'); ?></a> </li>
                                        </ul>
                                      </div>
                                    <div class="col-xs-9">
                                        <div class="tab-content">
                                            ...
                                            <!-- siltech edit -->
                                            <div class="tab-pane fade in " id="tab_edit_siltech_setting">
