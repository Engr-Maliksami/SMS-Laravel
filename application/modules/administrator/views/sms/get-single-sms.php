<div class="" data-example-id="togglable-tabs">
    <ul  class="nav nav-tabs bordered">
        ...
        <li  class=""><a href="#tab_pop_siltech_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('siltech_sms'); ?> </a> </li>
    </ul>
    <br/>
     ...
     <div class="tab-content">
        ...
        <!-- siltech -->
        <div  class="tab-pane fade in" id="tab_pop_siltech_setting" >
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>
              <tr>
                  <th width="50%"><?php echo $this->lang->line('siltech_sms'); ?> <?php echo $this->lang->line('sender_id'); ?></th>
                  <td><?php echo $sms_setting->siltech_sender_id; ?></td>
              </tr>
              <tr>
                  <th width="50%"><?php echo $this->lang->line('siltech_sms'); ?> <?php echo $this->lang->line('campaign_id'); ?></th>
                  <td><?php echo $sms_setting->siltech_campaign_id; ?></td>
              </tr>
              <tr>
                  <th width="50%"><?php echo $this->lang->line('siltech_sms'); ?> <?php echo $this->lang->line('route_id'); ?></th>
                  <td><?php echo $sms_setting->siltech_route_id; ?></td>
              </tr>
                <tr>
                    <th width="50%"><?php echo $this->lang->line('siltech_sms'); ?> <?php echo $this->lang->line('api_key'); ?></th>
                    <td><?php echo $sms_setting->siltech_api_key; ?></td>
                </tr>
                <tr>
                    <th><?php echo $this->lang->line('siltech_sms'); ?> <?php echo $this->lang->line('is_active'); ?></th>
                    <td><?php echo $sms_setting->siltech_status ? $this->lang->line('yes'): $this->lang->line('no'); ?></td>
                </tr>
            </tbody>
            </table>
        </div>
