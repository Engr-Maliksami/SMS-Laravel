                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_year_list" >
                            ...
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?> 
                                    <select  class="form-control col-md-7 col-xs-12" onchange="get_year_by_school(this.value);">
                                        <option value="<?php echo site_url('administrator/year/index/'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'administrator', 'year')){ ?>
                                                    <a href="<?php echo site_url('administrator/year/edit/'.$obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'administrator', 'year')){ ?>
                                                    <?php if(!$obj->is_running){ ?>
                                                    <a href="<?php echo site_url('administrator/year/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i></a>
                                                    <?php } ?>
                                                <?php } ?>
                                                <?php if(has_permission(EDIT, 'administrator', 'year')){ ?>    
