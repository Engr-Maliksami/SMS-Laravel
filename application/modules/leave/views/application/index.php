                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'leave', 'type')){ ?>
                             <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('leave/application/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('application'); ?></a> </li>                          
                             <?php }else{ ?>
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_application_list" >
                            ...
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                  
                                <select  class="form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_application_by_school_filter(this.value)">
                                    <option value="<?php echo site_url('leave/application/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_application">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/application/add'), array('onSubmit'=> 'return add_checkform()','name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <?php if(isset($edit)){ ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/application/edit/'.$application->id), array('onSubmit'=> 'return edit_checkform()','name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
...
<script type="text/javascript">
    ...
    $("#attachment").change(function(){
            ...
            $('#attachment_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "School",
                    text: "Leave Attachment  "+ input.files[0].name+ " selected",
                    type: "success",
...
<link href="<?php echo VENDOR_URL; ?>datepicker/datepicker.css" rel="stylesheet">
 ...
 <script type="text/javascript">
    ...
    function edit_checkform(){
        var startDate = $('#edit_leave_from').val();
        var endDate = $('#edit_leave_to').val();
    ...
    function add_checkform(){
        var startDate = $('#add_leave_from').val();
        var endDate = $('#add_leave_to').val();
        var NewstartDate = startDate.split("-").reverse().join("-");
        var NewendDate = endDate.split("-").reverse().join("-");
