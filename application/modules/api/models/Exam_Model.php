...
class Exam_Model extends MY_Model {
    ...
    function save_exam_mapping_list($type,$exam_id,$max_marks,$exam_type_id,$subject_id,$class_id,$academic_year_id){           
        ...
        $mapping = $this->db->insert('exam_type_mapping', $data);
            ...
            // to delete the existing mapping for current id and for particular academic year id
