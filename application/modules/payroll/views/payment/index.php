                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'payroll', 'payment')){ ?>
                                                    <a href="<?php echo site_url('payroll/payment/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'payroll', 'payment')){ ?>
                                                    <a href="javascript:void(0);"  onclick="getPaymentModal(<?php echo $obj->id; ?>,'<?php echo $payment_to; ?>');"  data-toggle="modal" data-target=".bs-example-modal-lg"><i class="changeFaColor fa fa-eye"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'payroll', 'payment')){ ?>
                                                    <a href="<?php echo site_url('payroll/payment/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    ...
                                    <div class="row">                                        
                                        ...
                                        <?php if($payment->salary_type == 'monthly'){ ?>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <input  class="form-control col-md-7 col-xs-12"  name="transport"  id="add_transport" value="<?php echo $payment->transport; ?>" placeholder="<?php echo $this->lang->line('transport'); ?> <?php echo $this->lang->line('allowance'); ?>" readonly="readonly" type="number" autocomplete="off">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <input  class="form-control col-md-7 col-xs-12"  name="medical"  id="add_medical" value="<?php echo $payment->medical; ?>" placeholder="<?php echo $this->lang->line('medical'); ?> <?php echo $this->lang->line('allowance'); ?>" readonly="readonly" type="number" autocomplete="off">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12 fn_add_claculate" min="0"  name="bonus"  id="add_bonus" value="" placeholder="<?php echo $this->lang->line('bonus'); ?>"  type="number" autocomplete="off">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12 fn_add_claculate" min="0" name="penalty"  id="add_penalty" value="" placeholder="<?php echo $this->lang->line('penalty'); ?>" type="number" autocomplete="off">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12 "  name="total_allowance"  id="add_total_allowance" value="<?php echo $payment->salary_type == 'monthly' ? $payment->total_allowance : ''; ?>" placeholder="<?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('allowance'); ?>" type="number" readonly="readonly" autocomplete="off">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12 "  name="total_deduction"  id="add_total_deduction" value="<?php echo $payment->salary_type == 'monthly' ? $payment->total_deduction : ''; ?>" placeholder="<?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('deduction'); ?>" type="number" readonly="readonly" autocomplete="off">
                               ...
                               <?php echo form_open(site_url('payroll/payment/edit/'.$edit_payment->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <?php if($payment->salary_type == 'monthly'){ ?>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="transport"><?php echo $this->lang->line('transport'); ?> <?php echo $this->lang->line('allowance'); ?> </label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="transport"  id="edit_transport" value="<?php echo $edit_payment->transport; ?>" placeholder="<?php echo $this->lang->line('transport'); ?>  <?php echo $this->lang->line('allowance'); ?>" readonly="readonly" type="number" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('transport'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="medical"><?php echo $this->lang->line('medical'); ?> <?php echo $this->lang->line('allowance'); ?> </label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="medical"  id="edit_medical" value="<?php echo $edit_payment->medical; ?>" placeholder="<?php echo $this->lang->line('medical'); ?> <?php echo $this->lang->line('allowance'); ?>" readonly="readonly" type="number" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('medical'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
