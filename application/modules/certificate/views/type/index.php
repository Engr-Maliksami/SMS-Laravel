<div class="row">
                                    ...
                                    <?php  $count = 1; if(isset($certificates) && !empty($certificates)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(VIEW, 'certificate', 'type')){ ?>
                                                    <a href="<?php echo site_url('certificate/type/view/'.$obj->id); ?>" ><i class="changeFaColor fa fa-eye"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(EDIT, 'certificate', 'type')){ ?>
                                                    <a href="<?php echo site_url('certificate/type/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'certificate', 'type')){ ?>
                                                    <a href="<?php echo site_url('certificate/type/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    ...
                                    <div class="item form-group">
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             ...
                                             <div class="photo-details" id="background_filename"></div>
                            ...
                            <div class="x_content"> 
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($certificate) ? $certificate->name : ''; ?>" placeholder="<?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text" autocomplete="off">
                                             <div class="help-block"><?php echo form_error('name'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="top_title"><?php echo $this->lang->line('school'); ?> <?php echo $this->lang->line('name'); ?> <span class="required">*</span></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control col-md-7 col-xs-12"  name="top_title"  id="top_title" value="<?php echo isset($certificate) ? $certificate->top_title : ''; ?>" placeholder="<?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text" autocomplete="off">
                                             <div class="help-block"><?php echo form_error('top_title'); ?></div>
                                         </div>
                                     </div>
 ...
 <script type="text/javascript">
     ...
     $("#background").change(function(){
            ...
            $('#background_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Certificate",
                    text: "Background  "+ input.files[0].name+ " selected",
                    type: "success",
