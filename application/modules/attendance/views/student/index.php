                            ...
                            <select  class="form-control col-md-7 col-xs-12" name="class_id" id="class_id"  required="required" onchange="get_section_by_class(this.value, '');">
                                ...
                                <?php if(isset($classes) && !empty($classes)) { ?>
                                    <?php foreach ($classes as $obj) { ?>
                                        <?php if($this->session->userdata('role_id') == TEACHER && $this->session->userdata('profile_id') != $obj->teacher_id){ continue;}  ?>
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $attendance = get_student_attendance($obj->id, $school_id, $academic_year_id, $class_id, $section_id, $year, $month, $day ); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($obj->photo != '') { ?>
                                            <img class="changeBorder" src="<?php echo UPLOAD_PATH; ?>/student-photo/<?php echo $obj->photo; ?>" alt="" width="40" /> 
                                        <?php } else { ?>
