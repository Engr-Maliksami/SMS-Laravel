                    ...
                    <div class="tab-content">
                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_email_list" >
                            ...
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                  
                                <select  class="form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_email_by_school(this.value)">
                                    <option value="<?php echo site_url('attendance/absentemail/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                    <?php foreach($schools as $obj ){ ?>
                                        <option value="<?php echo site_url('attendance/absentemail/index/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?></option>
                                    <?php } ?>   
                                </select>                            
                                    ...
                                    <?php $count = 1; if(isset($emails) && !empty($emails)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(VIEW, 'attendance', 'absentemail')){ ?>
                                                    <a  onclick="get_email_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-email-modal-lg"><i class="changeFaColor fa fa-eye"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'attendance', 'absentemail')){ ?>    
                                                    <a href="<?php echo site_url('attendance/absentemail/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
...
<link href="<?php echo VENDOR_URL; ?>datepicker/datepicker.css" rel="stylesheet">
 ...
 <script type="text/javascript">
    ...
    function get_user_by_role(role_id, user_id){       
       ...
       get_email_template_by_role(role_id, school_id);
   }
   ...
   function get_email_template_by_role(role_id, school_id){
