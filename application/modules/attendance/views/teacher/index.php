                ...
                <table id="datatable-responsive" class="table table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_attendance">   
                        ...
                        if (isset($teachers) && !empty($teachers)) {
                            ...
                            <?php  $attendance = get_teacher_attendance($obj->id, $school_id, $academic_year_id, $year, $month, $day ); ?>
                                <tr>
                                    <td><?php echo $count++;  ?></td>
                                    <td>
                                        <?php if ($obj->photo != '') { ?>
                                            <img class="changeBorder" src="<?php echo UPLOAD_PATH; ?>/teacher-photo/<?php echo $obj->photo; ?>" alt="" width="30" /> 
                                        <?php } else { ?>
  ...
  $(document).ready(function(){
       ...
       $('.fn_single_attendnce').click(function(){
          ...
          $.ajax({       
            ...
            data   : {school_id:school_id, status : status , teacher_id: teacher_id, class_id:class_id, section_id:section_id, date:date},               
            async  : false,
