                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="form-control col-md-7 col-xs-12" onchange="get_image_by_school(this.value);">
                                    <option value="<?php echo site_url('gallery/image/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('gallery/image/edit/'.$image->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="caption"><?php echo $this->lang->line('image'); ?> <?php echo $this->lang->line('caption'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="caption"  id="caption" value="<?php echo isset($image->caption) ?  $image->caption : ''; ?>" placeholder="<?php echo $this->lang->line('image'); ?> <?php echo $this->lang->line('caption'); ?>" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('caption'); ?></div>
                                    </div>
                                </div>
