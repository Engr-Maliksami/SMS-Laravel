                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                            <select  class="form-control col-md-7 col-xs-12" onchange="get_event_by_school(this.value);">
                                    <option value="<?php echo site_url('event/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'event', 'event')){ ?>
                                                    <a href="<?php echo site_url('event/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                               <?php if(has_permission(VIEW, 'event', 'event')){ ?>
                                                    <a  onclick="get_event_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-event-modal-lg"  ><i class="changeFaColor fa fa-eye"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'event', 'event')){ ?>
                                                    <a href="<?php echo site_url('event/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_event">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('event/add'), array('onSubmit'=> 'return add_checkform()','name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_event">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('event/edit/'.$event->id), array('onSubmit'=> 'return edit_checkform()','name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($event->title) ?  $event->title : ''; ?>" placeholder="<?php echo $this->lang->line('event'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
...
$("#image").change(function(){
  ...
  function edit_checkform(){
        var startDate = $('#edit_event_from').val();
        var endDate = $('#edit_event_to').val();
    ...
    function add_checkform(){
        var startDate = $('#add_event_from').val();
        var endDate = $('#add_event_to').val();
        var NewstartDate = startDate.split("-").reverse().join("-");
        var NewendDate = endDate.split("-").reverse().join("-");
