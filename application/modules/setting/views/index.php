        ...
        <div class="x_panel">
            ...
            <div class="x_content quick-link">
                ...
                <?php if(has_permission(VIEW, 'setting', 'emailsetting')){ ?>
                   | <a href="<?php echo site_url('setting/emailsetting'); ?>"><?php echo $this->lang->line('email'); ?> <?php echo $this->lang->line('setting'); ?></a>                    
                <?php } ?>    
            </div>
             ...
             <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                     <ul  class="nav nav-tabs bordered">                     
                        <li  class="active"><a href="#tab_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('school'); ?> <?php echo $this->lang->line('setting'); ?></a> </li> 
                     </ul>
                     <br/>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <?php if($school->frontend_logo){ ?>
                                               <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $school->frontend_logo; ?>" alt="" width="70" style="background: #2983d0; padding: 5px;"/><br/><br/>
