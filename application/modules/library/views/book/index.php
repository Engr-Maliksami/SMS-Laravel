                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'library', 'book')){ ?>
                                                    <a href="<?php echo site_url('library/book/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'library', 'book')){ ?>
                                                    <a  onclick="get_book_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-book-modal-lg"  ><i class="changeFaColor fa fa-eye"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'library', 'book')){ ?>
                                                    <a href="<?php echo site_url('library/book/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="photo-details" id="cover_filename"></div>
...
<script type="text/javascript">
         ...
         $("#cover").change(function(){
            ...
            $('#cover_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Library",
                    text: "Book Cover  "+ input.files[0].name+ " selected",
                    type: "success",
