                            ...
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>
                                <div class="row"><div class="col-xs-12"><div class="col-xs-6"> 
                                 <select  class="form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_class_by_school(this.value,'')">
                                    ...
                                    <div class="col-xs-6">                           
                                <select  class="form-control col-md-7 col-xs-12 auto-width" name="class_id_filter" id="class_id_filter" onchange="get_ebook_by_class_filter(this.value);" >
                                ...
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_ebook_by_class(this.value);">
                                    ...
                                    <?php foreach($class_list as $obj ){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT){ ?>
                                            ...
                                            <option value="<?php echo site_url('library/ebook/index/'.$obj->id); ?>" <?php if(isset($class_id) && $class_id == $obj->id){ echo 'selected="selected"';} ?> ><?php echo $this->lang->line('class'); ?> <?php echo $obj->name; ?></option>
                               ...
                               <?php echo form_open_multipart(site_url('library/ebook/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="photo-details" id="cover_image_filename"></div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="photo-details" id="file_name_filename"></div>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('library/ebook/edit/'.$ebook->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($ebook->name) ?  $ebook->name : $post['name']; ?>" placeholder="<?php echo $this->lang->line('e_book'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
...
<script type="text/javascript">
         ...
         $("#cover_image").change(function(){
            ...
            $('#cover_image_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Library",
                    text: "Cover Image  "+ input.files[0].name+ " selected",
                    type: "success",
         ...
         $("#file_name").change(function(){
            ...
            $('#file_name_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Library",
                    text: "E-Book  "+ input.files[0].name+ " selected",
                    type: "success",
                    confirmButtonText: "OK"
                });
         });
...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">
   ...
   /* Menu Filter Start */
    ...
    function get_ebook_by_class_filter(class_id){
       ...
       window.location.href = '<?php echo site_url('library/ebook/index/'); ?>'+class_id+'/'+school_id; 
