                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'accounting', 'feetype')){ ?>
                             <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('accounting/feetype/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('fee_type'); ?></a> </li>                          
                             <?php }else{ ?>
                                    ...
                                    <?php $count = 1; if(isset($feetypes) && !empty($feetypes)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine"> 
                                                <?php if(has_permission(VIEW, 'accounting', 'feetype')){ ?>
                                                    <a  onclick="get_feetype_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-feetype-modal-lg"><i class="changeFaColor fa fa-eye"></i> </a>
                                                <?php  } ?>
                                                <?php if(has_permission(EDIT, 'accounting', 'feetype')){ ?>
                                                    <a href="<?php echo site_url('accounting/feetype/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'accounting', 'feetype')){ ?>
                                                    <a href="<?php echo site_url('accounting/feetype/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                <?php } ?>                                  
                                            </td>
                                        </tr>
                                        <?php } ?>
...
//     setInputFilter(document.getElementsByName("fee_amount[]"), function(value) {
