                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'accounting', 'exphead')){ ?>
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('accounting/exphead/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('expenditure_head'); ?></a> </li>                          
                             <?php }else{ ?>
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="form-control col-md-7 col-xs-12" onchange="get_head_by_school(this.value);">
                                <option value="<?php echo site_url('accounting/exphead/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">   
                                                <?php if(has_permission(EDIT, 'accounting', 'exphead')){ ?>
                                                    <a href="<?php echo site_url('accounting/exphead/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'accounting', 'exphead')){ ?>
                                                    <a href="<?php echo site_url('accounting/exphead/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
