            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li  class="<?php if(isset($single)){ echo 'active'; }?>"><a href="<?php echo site_url('accounting/invoice/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('create'); ?> <?php echo $this->lang->line('invoice'); ?></a> </li>                          
                        <li  class="<?php if(isset($bulk)){ echo 'active'; }?>"><a href="<?php echo site_url('accounting/invoice/bulk'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('create'); ?> <?php echo $this->lang->line('bulk'); ?> <?php echo $this->lang->line('invoice'); ?></a> </li>                          
                        <?php if(isset($edit)){ ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accounting/invoice/add'), array('name' => 'single', 'id' => 'single', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" name="income_head_id" id="add_income_head_id" required="required" onchange="get_fee_amount(this.value, 'single');">
                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accounting/invoice/bulk'), array('name' => 'bulk', 'id' => 'bulk', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="income_head_id?"><?php echo $this->lang->line('fee'); ?> <?php echo $this->lang->line('type'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" name="income_head_id" id="add_income_head_id" required="required" onchange="get_student_and_fee_amount(this.value);">
                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($income_heads) && !empty($income_heads)){ ?>
                                                <?php foreach($income_heads as $obj ){ ?>
                                                    <option value="<?php echo $obj->id; ?>" ><?php echo $obj->title; ?></option>
...
<script type="text/javascript"> 
    ...
    function get_student_by_class(class_id, student_id, type){       
        ...
        $.ajax({       
            ...
            data   : {school_id:school_id, class_id : class_id , student_id : student_id, type : type},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {     
   ...
   function get_fee_amount(income_head_id, type){
       ...
       var student_id = $('#'+type+'_student_id').val();
        ...
        $.ajax({       
            ...
            data   : { school_id:school_id, class_id : class_id , student_id : student_id, income_head_id : income_head_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {                    
 ...
 /* Bulk invoice */  
   ...
   function get_student_and_fee_amount(income_head_id){
        ...
        $.ajax({       
            ...
            data   : { school_id:school_id, class_id : class_id , income_head_id : income_head_id},               
            async  : false,
            success: function(response){                                                   
               if(response == 'ay')
               {                    
