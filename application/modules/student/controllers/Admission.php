...
class Admission extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_admission_validation() {
        ...
        $this->form_validation->set_rules('type_id', $this->lang->line('student').' '.$this->lang->line('student'), 'trim|required');
        ...
        // guardian fields
        $this->form_validation->set_rules('guardian_name', $this->lang->line('guardian').' '. $this->lang->line('name'), 'trim|required');
        $this->form_validation->set_rules('guardian_phone', $this->lang->line('guardian').' '. $this->lang->line('phone'), 'trim|required');
    ...
    * ********************************************************** */
    private function _get_posted_admission_data() {
        ...
        if($this->input->post('guardian_id')){
            ...
            //$info['username'] = strtolower(strtok($this->input->post('guardian_name'), " ")); 
