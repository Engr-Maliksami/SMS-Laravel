        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                $id = $this->student->get_user_id($this->input->post('school_id'));
                      ...
                      $admission = $this->student->update_admission_no($insert_id);

                        if ($insert_id) {
                            //$roll_no = get_addimission_no_by_student_id($insert_id);
                            //echo $insert_id;echo '<pre>';print_r($roll_no);die();
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if ($id) {            
            ...
            $this->data['global'] = get_school_settings($student->school_id);
            //echo '<pre>';print_r($this->data['global']);die();  
