            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_admission_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('admission'); ?> <?php echo $this->lang->line('list'); ?></a> </li>                      <?php if(isset($edit)){ ?>
                        ...
                        <li class="li-class-list">
                                ...
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_student_by_class(this.value);">
                                    ...
                                    <?php foreach($classes as $obj ){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT && $this->session->userdata('class_id') == $obj->id){ ?>
                                            <option value="<?php echo site_url('student/admission/index/'.$obj->id); ?>" <?php if(isset($class_id) && $class_id == $obj->id){ echo 'selected="selected"';} ?> ><?php echo $this->lang->line('class'); ?> <?php echo $obj->name; ?></option>
                            ...
                            <?php }else{ ?> 
                                <div class="row"><div class="col-xs-12"><div class="col-xs-6"
                               ...
                               <div class="row">                  
                                ...
                                <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="admission_date"  id="edit_admission_date" value="<?php echo isset($admission->created_at) ?   date('d-m-Y', strtotime($admission->created_at)) : ''; ?>" placeholder="<?php echo $this->lang->line('admission'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <?php if($admission->guardian_id){ ?>  
                                  <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="gud_relation"><?php echo $this->lang->line('relation_with'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="gud_relation"  id="gud_relation" readonly="readonly" value="<?php echo isset($admission->gud_relation) ?  $this->lang->line($admission->gud_relation) : ''; ?>" placeholder="<?php echo $this->lang->line('relation_with'); ?>" type="text" autocomplete="off">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12" name="gud_relation" id="gud_relation" >
                                                ...
                                                <?php foreach($relation_types as $key=>$value){ ?>
                                                    <option value="<?php echo $key; ?>" <?php if($admission->gud_relation == $key){ echo 'selected="selected"';} ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
                                            <div class="help-block"><?php echo form_error('gud_relation'); ?></div>
                                        </div>
                                ...
                                <div class="row">                                      
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="form-control col-md-7 col-xs-12 quick-field" name="type_id" id="type_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
