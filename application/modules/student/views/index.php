                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_student_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'student', 'student')) { ?>
                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('student/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('student'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_student" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('student'); ?></a> </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in <?php if (isset($list)) {
                            ...
                            <div class="x_content">
                            <div class="row school-select-btn">
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) {  ?>
                                <div class="col-md-8"></div><div class="col-md-2">
                                            ...
                                            <select class="form-control" style="width:auto;" name="school_id" onchange="get_class_by_school(this.value, '');">
                                        ...
                                        <div class="col-md-2">
                                            <select class="form-control" id="filter_class_id" name="class_id" style="width:auto;" onchange="this.form.submit();">
                            ...
                            <?php } else {  ?>
                                ...
                                <select class="form-control" onchange="get_student_by_class(this.value);">
                                    ...
                                    <?php foreach ($classes as $obj) { ?>
                                        <?php if ($this->session->userdata('role_id') == STUDENT) { ?>
                                            ...
                                            <option value="<?php echo site_url('student/index/' . $obj->id); ?>" <?php if (isset($class_id) && $class_id == $obj->id) {
                                                                                                                    echo 'selected="selected"';
                                                                                                                } ?>><?php echo $this->lang->line('class'); ?> <?php echo $obj->name; ?></option>
                                        ...
                                        <?php } elseif ($this->session->userdata('role_id') == TEACHER) { ?>
                                            <?php if (!in_array($obj->id, $teacher_student_data)) {
                                                continue;
                                            } ?>
                                            <option value="<?php echo site_url('student/index/' . $obj->id); ?>" <?php if (isset($class_id) && $class_id == $obj->id) {
                                                                                                                    echo 'selected="selected"';
                                        ...
                                        if (isset($students) && !empty($students)) { ?>
                                            <?php foreach ($students as $obj) { ?>
                                                ...
                                                if ($this->session->userdata('role_id') == GUARDIAN) {
                                                    if (!in_array($obj->id, $guardian_student_data)) {
                                                        continue;
                                                    }
                                                } elseif ($this->session->userdata('role_id') == TEACHER) {
                                                    if (!in_array($obj->class_id, $teacher_student_data)) {
                                                        continue;
                                                    }
                                                }
                                                ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($obj->photo != '') { ?>
                                                            <img class="changeBorder" src="<?php echo UPLOAD_PATH; ?>/student-photo/<?php echo $obj->photo; ?>" alt="" width="30" />
                                                        <?php } else { ?>
                                                            <img class="changeBorder" src="<?php echo IMG_URL; ?>/default-user.png" alt="" width="30" />
                                                        <?php } ?>
                                                    </td>
                                                    ...
                                                    <td class="displayOneLine">
                                                        <?php if (has_permission(EDIT, 'student', 'student')) { ?>
                                                            <a href="<?php echo site_url('student/edit/' . $obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i></a><br />
                                                        <?php } ?>
                                                        <?php if (has_permission(VIEW, 'student', 'student')) { ?>
                                                            <a href="javascript:void(0);" onclick="get_student_modal(<?php echo $obj->id; ?>);" data-toggle="modal" data-target=".bs-student-modal-lg"><i class=" changeFaColor fa fa-eye"></i> </a>
                                                        <?php } ?>
                                                        <?php if (has_permission(DELETE, 'student', 'student')) { ?>
                                                            <a href="<?php echo site_url('student/delete/' . $obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                <?php echo form_open_multipart(site_url('student/add'), array('onSubmit' => 'return add_checkform()', 'name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input readonly class="form-control col-md-7 col-xs-12" name="admission_no" id="admission_no" value="" placeholder="Auto Generated"  type="text" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="photo-details" id="transfer_certificate_filename"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="photo-details" id="father_photo_filename"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="photo-details" id="mother_photo_filename"></div>
                                            <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="photo-details" id="photo_filename"></div>
                                            <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                        ...
                        <?php if (isset($edit)) { ?>
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_student">
                                <div class="x_content">
                                    <?php echo form_open_multipart(site_url('student/edit/' . $student->id), array('onSubmit' => 'return edit_checkform()', 'name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="admission_no"><?php echo $this->lang->line('admission_no'); ?> </label>
                                                <input readonly class="form-control col-md-7 col-xs-12" name="admission_no" id="admission_no" value="<?php echo isset($student->admission_no) ?  $global->admission_prefix.''.$student->admission_no : ''; ?>" placeholder="<?php echo $this->lang->line('admission_no'); ?>"  type="text" autocomplete="off">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="blood_group" id="blood_group">
                                                    ...
                                                    <?php $bloods = get_blood_group(); ?>
                                                    <?php foreach ($bloods as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php if ($student->blood_group == $key) {
                                                                                                echo 'selected="selected"';
                                                                                            } ?>><?php echo $value; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12 quick-field" name="guardian_id" id="edit_guardian_id" required="required" onchange="get_guardian_by_id(this.value);">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <?php foreach ($guardians as $obj) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($student->guardian_id == $obj->id) {
                                                                                                    echo 'selected="selected"';
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="relation_with" id="relation_with">
                                                    ...
                                                    <?php $relation_types = get_relation_types(); ?>
                                                    <?php foreach ($relation_types as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php if ($student->relation_with == $key) {
                                                                                                echo 'selected="selected"';
                                                                                            } ?>><?php echo $value; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12 quick-field" name="class_id" id="edit_class_id" required="required" onchange="get_section_by_class(this.value, '');">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <?php foreach ($classes as $obj) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($student->class_id == $obj->id) {
                                                                                                    echo 'selected="selected"';
                                                                                                } ?>><?php echo $obj->name; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="group" id="group">
                                                    ...
                                                    <?php $groups = get_groups(); ?>
                                                    <?php foreach ($groups as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php if ($student->group == $key) {
                                                                                                echo 'selected="selected"';
                                                                                            } ?>><?php echo $value; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="role_id" id="role_id" required="required">
                                                    <?php foreach ($roles as $obj) { ?>
                                                        <?php if (in_array($obj->id, array(STUDENT))) { ?>
                                                            <option value="<?php echo $obj->id; ?>" <?php if ($student->role_id == $obj->id) {
                                                                                                        echo 'selected="selected"';
                                                                                                    } ?>><?php echo $obj->name; ?></option>
                                                        <?php } ?>
                                                    <?php } ?>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12 quick-field" name="discount_id" id="edit_discount_id">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <?php foreach ($discounts as $obj) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($student->discount_id == $obj->id) {
                                                                                                    echo 'selected="selected"';
                                                                                                } ?>><?php echo $obj->title; ?> [<?php echo $obj->amount; ?>%]</option>
                                                    <?php } ?>
                                                </select>
                                                <div class="help-block"><?php echo form_error('discount_id'); ?></div>
                                            </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <?php if ($student->transfer_certificate) { ?>
                                                    <img class="changeBorder" src="<?php echo UPLOAD_PATH; ?>/transfer-certificate/<?php echo $student->transfer_certificate; ?>" alt="" width="30" /><br /><br />
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
...
$("#father_photo").change(function(){
         ...
         $('#father_photo_filename').html('File name: ' + input.files[0].name);
            swal({
                title: "Student",
                text: "Father's  Image  "+ input.files[0].name+ " selected",
                type: "success",
 ...
 $("#transfer_certificate").change(function(){
         var input = document.getElementById( 'transfer_certificate' );
         $('#transfer_certificate_filename').html('File name: ' + input.files[0].name);
            swal({
                title: "Student",
                text: "Transfer certificate  Image  "+ input.files[0].name+ " selected",
                type: "success",
                confirmButtonText: "OK"
            });
 });
 ...
 $("#mother_photo").change(function(){
         ...
         $('#mother_photo_filename').html('File name: ' + input.files[0].name);
            swal({
                title: "Student",
                text: "Mother's  Image  "+ input.files[0].name+ " selected",
                type: "success",
                confirmButtonText: "OK"
            });
 });
 ...
 $("#photo").change(function(){
         ...
         $('#photo_filename').html('File name: ' + input.files[0].name);
            swal({
                title: "Student",
                text: "Student's  Photo  "+ input.files[0].name+ " selected",
                type: "success",
                confirmButtonText: "OK"
            });
 });
...
<script type="text/javascript">
    ...
    function setInputFilter(textbox, inputFilter) { 
        ["input", "keydown", "keyup", "mousedown", "mouseup", "select", "contextmenu", "drop"].forEach(function(event) {
            textbox.addEventListener(event, function() {
                console.log("1====>>",textbox);
                if(this.hasOwnProperty("oldValue") && this.value=='') {
                    console.log("check this====>>",this.value);
                    this.value = this.value;
                }else
                if (inputFilter(this.value)) {
                    this.oldValue = this.value;
                    console.log("2====>>",this.oldValue);
    ...
    setInputFilter(document.getElementById("add_phone"), function(value) {
        return /^[\d\(\)\-+ _]+$/.test(value);
    });

    setInputFilter(document.getElementById("mother_phone"), function(value) {
        return /^[\d\(\)\-+ _]+$/.test(value);
    });

    setInputFilter(document.getElementById("father_phone"), function(value) {
        return /^[\d\(\)\-+ _]+$/.test(value);
    });
    ...
    $('#add_dob').datepicker({  endDate: "today" });
    $('#edit_dob').datepicker({  endDate: "today" }); 

    function edit_checkform() {
        var startDate = $('#edit_dob').val();
        var endDate = $('#edit_admission_date').val();
        ...
        if (NewstartDate > NewendDate) {
            swal({
                title: "Student",
                text: "Birth Date cannot be greater than Admission Date",
                type: "error",
                confirmButtonText: "OK"
            });
            return false;
    ...
    function add_checkform() {
        var startDate = $('#add_dob').val();
        var endDate = $('#add_admission_date').val();
        var NewstartDate = startDate.split("-").reverse().join("-");
        var NewendDate = endDate.split("-").reverse().join("-");

        if (NewstartDate > NewendDate) {

            //swal("Oops...", "Something went wrong", "error", customClass: "mySwal");
            // swal({
            //      title: 'Student',
			//      text: 'Birth Date cannot be greater than Admission Date',
			//      customClass: "mySwal"
	        // });
            // $('.mySwal fieldset,.mySwal .sa-error-container').attr('style', 'display:none');
