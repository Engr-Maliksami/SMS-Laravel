        ...
        <div class="x_panel">
                                    ...
                                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>
                                       ...
                                       <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="form-control col-md-7 col-xs-12 fn_school_id" name="school_id" id="school_id" required="required" onchange="get_class_by_school(this.value);">
	        ...
	        <div class="col-md-12 col-sm-12 col-xs-12">		
	            <div class="errors"><strong>Errors: </strong> 		
	                    ...
	                    <?php } ?>		
	                    <br>		
	                    NOTE : These particular entries of Student in Uploaded Sheet were not added. Correct their numbers and upload them again.                        		
