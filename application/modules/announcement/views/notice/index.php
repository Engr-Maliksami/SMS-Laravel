                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                            <select  class="form-control col-md-7 col-xs-12" onchange="get_notice_by_school(this.value);">
                                    <option value="<?php echo site_url('announcement/notice/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'announcement', 'notice')){ ?>
                                                    <a href="<?php echo site_url('announcement/notice/edit/'.$obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'announcement', 'notice')){ ?>
                                                    <a  onclick="get_notice_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-notice-modal-lg"  ><i class="changeFaColor fa fa-eye"></i> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'announcement', 'notice')){ ?>
                                                    <a href="<?php echo site_url('announcement/notice/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="x_content">
                               ...
                               <?php echo form_open(site_url('announcement/notice/edit/'.$notice->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($notice->title) ?  $notice->title : ''; ?>" placeholder="<?php echo $this->lang->line('notice'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
