                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                            <select  class="form-control col-md-7 col-xs-12" onchange="get_holiday_by_school(this.value);">
                                    <option value="<?php echo site_url('announcement/holiday/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'announcement', 'holiday')){ ?>
                                                    <a href="<?php echo site_url('announcement/holiday/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                <?php } ?>
                                               <?php if(has_permission(VIEW, 'announcement', 'holiday')){ ?>
                                                    <a  onclick="get_holiday_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-holiday-modal-lg" ><i class="changeFaColor fa fa-eye"></i></a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'announcement', 'holiday')){ ?>
                                                    <a href="<?php echo site_url('announcement/holiday/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_holiday">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('announcement/holiday/add'), array('name' => 'add', 'id' => 'add','onSubmit'=> 'return add_checkform()', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_holiday">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('announcement/holiday/edit/'.$holiday->id), array('onSubmit'=> 'return edit_checkform()','name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($holiday->title) ?  $holiday->title : ''; ?>" placeholder="<?php echo $this->lang->line('holiday'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
