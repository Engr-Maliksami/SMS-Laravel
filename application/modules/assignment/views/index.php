                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_assignment_list" >
                            <div class="x_content">
                            <div class="row school-select-btn" ><div class="col-md-8"></div>
                            <?php $teacher_access_data = get_teacher_access_data('student'); ?> 
                            <?php $guardian_access_data = get_guardian_access_data('class'); ?>   
                                
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>
                                <div class="col-md-2">
                                <?php echo form_open(site_url('assignment/index'), array('name' => 'filter', 'id' => 'filter', 'class'=>'form-horizontal form-label-left'), ''); ?>
                            ...
                            <?php }else{  ?>
                                ...
                                <select  class="form-control " onchange="get_assignment_by_class(this.value);">
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'assignment', 'assignment')){ ?>
                                                    <a href="<?php echo site_url('assignment/edit/'.$obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php  } ?>
                                                <?php if(has_permission(VIEW, 'assignment', 'assignment')){ ?>
                                                    <a  onclick="get_assignment_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-assignment-modal-lg" ><i class="changeFaColor fa fa-eye"></i> </a>
                                                    <?php if($obj->assignment){ ?>
                                                    <a target="_blank" href="<?php echo UPLOAD_PATH; ?>/assignment/<?php echo $obj->assignment; ?>" class="btn btn-success btn-xs"><i class="changeFaColor fa fa-download"></i> </a>
                                                    <?php  } ?>
                                                <?php  } ?>
                                                <?php if(has_permission(DELETE, 'assignment', 'assignment')){ ?>
                                                    <a href="<?php echo site_url('assignment/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php  } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="photo-details" id="assignment_filename"></div>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('assignment/edit/'.$assignment->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($assignment->title) ?  $assignment->title : ''; ?>" placeholder="<?php echo $this->lang->line('assignment'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note"><?php echo $this->lang->line('note'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="note"  id="edit_note" placeholder="<?php echo $this->lang->line('note'); ?>"><?php echo isset($assignment->note) ?  $assignment->note : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('note'); ?></div>
                                    </div>
                                </div>
...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">
     ...
     $("#assignment").change(function(){
            ...
            $('#assignment_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Assignment",
                    text: "Assignment  "+ input.files[0].name+ " selected",
                    type: "success",
