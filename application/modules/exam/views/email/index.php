                         ...
                         <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_send_email_list" >
                            ...
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="form-control col-md-7 col-xs-12" onchange="get_email_by_school(this.value);">
                                     <option value="<?php echo site_url('exam/mail/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                ...
                                                <?php if(has_permission(DELETE, 'exam', 'mail')){ ?>      
                                                    <a href="<?php echo site_url('exam/mail/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/mail/send'), array('name' => 'sendemail', 'id' => 'sendemail', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="subject"  id="subject" value="" placeholder="<?php echo $this->lang->line('email'); ?> <?php echo $this->lang->line('subject'); ?>" required="required" type="text"  autocomplete="off">
