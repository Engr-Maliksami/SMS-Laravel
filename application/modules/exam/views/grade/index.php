                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'exam', 'grade')){ ?>
                                                    <a href="<?php echo site_url('exam/grade/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i> </a>
                                                <?php } ?>                                               
                                                <?php if(has_permission(DELETE, 'exam', 'grade')){ ?>
                                                    <a href="<?php echo site_url('exam/grade/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_grade">
                            <div class="x_content"> 
                               ...
                               <?php echo form_open(site_url('exam/grade/add'), array('onSubmit'=> 'return add_checkform()','name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_grade">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/grade/edit/'.$grade->id), array('onSubmit'=> 'return edit_checkform()','name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($grade->name) ?  $grade->name : ''; ?>" placeholder="<?php echo $this->lang->line('exam_grade'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
...
function setInputFilter(textbox, inputFilter) { 
    ...
    setInputFilter(document.getElementById("mark_to"), function(value) {
        return /^[\d\(\)\-+ _]+$/.test(value);
    });
    setInputFilter(document.getElementById("mark_from"), function(value) {
        return /^[\d\(\)\-+ _]+$/.test(value);
    });

 function edit_checkform(){
        var from = $('#mark_from').val();
        var to = $('#mark_to').val();
       if (from > to){
            swal({
                title: "Grade",
                text: "Mark From field cannot be greater than Mark To field",
                type: "error",
