                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                            ...
                                            <tr>
                                                ...
                                                <td class="displayOneLine">
                                                    <?php if(has_permission(EDIT, 'exam', 'schedule')){ ?>
                                                        <a href="<?php echo site_url('exam/schedule/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i></a>
                                                    <?php } ?>
                                                    <?php if(has_permission(VIEW, 'exam', 'schedule')){ ?>
                                                        <a  onclick="get_schedule_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-schedule-modal-lg" ><i class="changeFaColor fa fa-eye"></i>  </a>
                                                    <?php } ?>
                                                    <?php if(has_permission(DELETE, 'exam', 'schedule')){ ?>
                                                        <a href="<?php echo site_url('exam/schedule/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('conirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_schedule">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/schedule/add'), array('onSubmit'=> 'return add_checkform()','name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_schedule">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/schedule/edit/'.$schedule->id), array('onSubmit'=> 'return edit_checkform()','name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
...
<script type="text/javascript">
 ...
 <script src="<?php echo VENDOR_URL; ?>timepicker/moment.js"></script>
...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">
  ...
  function add_checkform(){
        var   timeFrom = $('#add_start_time').val();
        var      timeTo = $('#add_end_time').val();
        var start = moment.utc(timeFrom, "HH:mm");
        var end = moment.utc(timeTo, "HH:mm");
         if (end.isBefore(start) || end.isSame(start)){
            swal({
                title: "Schedule",
                text: "Start Time cannot not greater than or equal to End Time",
                type: "error",
    ...
    function edit_checkform(){
        var   timeFrom = $('#edit_start_time').val();
        var      timeTo = $('#edit_end_time').val();
        var start = moment.utc(timeFrom, "HH:mm");
        var end = moment.utc(timeTo, "HH:mm");
         if (end.isBefore(start) || end.isSame(start)){
            swal({
