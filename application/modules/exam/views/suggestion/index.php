                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'exam', 'suggestion')){ ?>
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('exam/suggestion/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('suggestion'); ?></a> </li>                          
                             <?php }else{ ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_suggestion_list" >                            
                            ...
                            <?php $teacher_access_data = get_teacher_access_data('student'); ?> 
                                ...
                                <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>
                                   ...
                                   <?php echo form_open(site_url('exam/suggestion/index'), array('name' => 'filter', 'id' => 'filter', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="displayOneLine">
                                                    <?php if(has_permission(EDIT, 'exam', 'suggestion')){ ?>
                                                        <a href="<?php echo site_url('exam/suggestion/edit/'.$obj->id); ?>" ><i class="changeFaColor fa fa-pencil-square-o"></i>  </a>
                                                     <?php } ?>
                                                    <?php if(has_permission(VIEW, 'exam', 'suggestion')){ ?>
                                                        <a  onclick="get_suggestion_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-suggestion-modal-lg"  ><i class="changeFaColor fa fa-eye"></i> </a>
                                                        <?php if($obj->suggestion){ ?>
                                                        <a target="_blank" href="<?php echo UPLOAD_PATH .'/suggestion/'. $obj->suggestion; ?>" class="btn btn-success btn-xs"><i class="changeFaColor fa fa-download"></i>  </a>
                                                        <?php } ?>
                                                    <?php } ?>
                                                   <?php if(has_permission(DELETE, 'exam', 'suggestion')){ ?>     
                                                        <a href="<?php echo site_url('exam/suggestion/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
                               ...
                               <?php echo form_open_multipart(site_url('exam/suggestion/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($post['title']) ?  $post['title'] : ''; ?>" placeholder="<?php echo $this->lang->line('suggestion'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="photo-details" id="suggestion_filename"></div>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/suggestion/edit/'.$suggestion->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($suggestion->title) ?  $suggestion->title : ''; ?>" placeholder="<?php echo $this->lang->line('suggestion'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                             ...
                             <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <a target="_blank" href="<?php echo UPLOAD_PATH; ?>/suggestion/<?php echo $suggestion->suggestion; ?>"><?php echo $suggestion->suggestion; ?></a> <br/>
                                        <?php } ?>
                                        <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                        <input  class="form-control col-md-7 col-xs-12"  name="suggestion"  id="suggestion" type="file">
...
<script type="text/javascript">
 ...
 <script type="text/javascript">     
       ...
       $("#suggestion").change(function(){
            ...
            $('#suggestion_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Exam Suggestion",
                    text: "Suggestion  "+ input.files[0].name+ " selected",
                    type: "success",
