                                ...
                                <?php if (isset($exams) && !empty($exams)) { ?>
                                    <?php foreach ($exams as $ex) { ?>
                                        ...
                                        ?>
                                            ...
                                            <?php echo '<pre>';print_r($exam_subjects); //die(); 
                                            ?>
                        ...
                        <table id="datatable-responsive" class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            ?>
                                ...
                                <?php foreach ($exams as $ex) { ?>
                                    ...
                                    <?php $mark = get_exam_wise_markt($school_id, $academic_year_id, $ex->id, $class_id, $std->section_id, $std->id); ?>
                                    <!-- <?php $obtain_total_mark = $mark->written_obtain + $mark->tutorial_obtain + $mark->practical_obtain + $mark->viva_obtain; ?> -->
                                    <?php $rank = get_position_in_exam($school_id, $academic_year_id, $ex->id, $class_id, $std->section_id, $obtain_total_mark); ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php   }
                                        ?>
                                        <td><?php echo 'SS' . $mark->written_mark + $mark->tutorial_mark + $mark->practical_mark + $mark->viva_mark; ?></td>
