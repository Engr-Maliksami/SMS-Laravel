        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <table id="datatable-responsive" class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_mark"> 
                         <?php //echo '<pre>';print_r($exams);//die(); ?>
                        ...
                        <?php foreach($exams as $ex){ ?>
                            ...
                            <?php 
                             //echo '<pre>';print_r($exam_subjects);//die();
                             foreach ($exam_subjects as $obj) { ?>
                            
                                <?php $exam = get_exam_result($school_id, $ex->id, $student_id, $academic_year_id, $class_id, $section_id); 
                                
                                $obtained_marks = get_exam_details($school_id, $ex->id, $class_id, $academic_year_id,$student_id); 
                                ...
                                $obtained_marks = get_exam_details_by_subject($school_id, $ex->id, $class_id, $academic_year_id,$obj->subject_id,$student_id);
                                ...
                                <tr>
                                    ...
                                    <?php  
                                      ...
                                      //die(); 
                                    //  foreach($obtained_marks as $obtained){
                                    ...
                                    <?php foreach($exam_types as $key => $types){
                                       ...
                                       <?php 
                                            //for($i;$i<count($total_exams);$i++){
                                                while($i<count($total_exams)){
                                                
                                                //echo 't='.$total_exams[$i];die();
                        ...
                        <?php }else{ ?>
                                <tr>
                                    <td colspan="19" align="center"><?php echo $this->lang->line('no_data_found'); ?></td>
                                </tr>
                        <?php } ?>   
                                
                    <?php }  echo '<pre>O';print_r($obtained);echo '<pre>M';print_r($maximum); ?>
                    <?php }else{ ?>
                            <tr>
                                <td colspan="19" align="center"><?php echo $this->lang->line('no_data_found'); ?></td>
                             </tr>    
                ...
                <table id="datatable-responsive" class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    ?>
                        ...
                        <?php  foreach ($exams as $ex) { ?>
                            ...
                            //echo '<pre>11';print_r($mark);die();
                            foreach ($exam_subjects as $sub){
                                $obtained_marks = get_exam_details_by_subject($school_id, $ex->id, $class_id, $academic_year_id,$sub->subject_id,$student_id);
                                
                                //echo '======OBTAINED';echo '<pre>';print_r($obtained_marks);
                                    foreach($obtained_marks as $result){
                                        ...
                                        //$result->exam_id.'_'.$result->subject_id.'_'.$result->max_marks
                                        //exam_id subject_id  marks_obtained max_marks

                                    }     
                                   // echo '<pre>';print_r($exam_type_details_result);  
                                // name=marks_'.$obj->id.'-'.$mark->id.'   exam_type_name 
                            } 
                            ...
                            <tr>
                                ...
                                <?php for($i=0;$i<count($total_exams);$i++){
                                    ...
                                    ?>
                                      <td><?php if(isset($maximum[$exa])){echo $maximum[$exa];}
                                      else { echo 'N/A';} ?></td>
                                ...
                                <td><?php echo $exam->total_obtain_mark; ?></td>
