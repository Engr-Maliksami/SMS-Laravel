                             ...
                             foreach ($exam_subjects as $obj) { ?>
                                ...
                                <tr>
                                    ...
                                    <?php foreach($exam_types as $key => $types){
                                       ...
                                       <?php 
                                            for($i=0;$i<count($total_exams);$i++){
                                                //echo $total_exams[$i];echo '==='; 
                                                //echo $i.'->'.$obtained_marks[$key]->exam_type_name;echo '</br>';
                    ...
                    ?>
                        ...
                        <?php  foreach ($exams as $ex) { ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $mark->exam_total_mark?></td>
                                
                                
                                <td><?php echo $mark->obtain_total_mark; ?></td>
