    ...
    * ********************************************************** */
    public function index() {
        ...
        if ($_POST) {
            ...
            $this->data['exam_types'] = get_exam_type_details($school_id, $class_id, $academic_year_id,$student_id);
    ...
    public function all() {
        ...
        if ($_POST) {
            ...
            //echo '<pre>ST';print_r($students);die();
            $this->data['exams']    = $this->resultcard->get_list('exams', array('school_id'=>$school_id, 'status' => 1, 'academic_year_id' => $academic_year_id), '', '', '', 'id', 'ASC');
            $this->data['exam_types'] = get_exam_type_details($school_id, $class_id, $academic_year_id,$students[0]->id);
            $this->data['school'] = $school;
            $this->data['school_id'] = $school_id;
            $this->data['academic_year_id'] = $academic_year_id;
