    ...
    public function index() {
        ...
        if ($_POST) {
            ...
            if(!$school->academic_year_id){
             ...
             $subject_id = $this->data['subjects'][0]->subject_id;
            
             $this->data['grades'] = $this->mark->get_list('grades', array('status' => 1, 'school_id'=>$school_id), '', '', '', 'id', 'ASC');

             //$this->data['exam_types'] = $this->mark->get_exam($school_id, $exam_id, $class_id, $school->academic_year_id,$subject_id);

             $this->data['exam_types'] = get_exam_type_details($school_id, $class_id, $school->academic_year_id,$student_id=null);

            $this->data['marks_details'] = $this->mark->get_marks_detail($school_id, $exam_id, $class_id, $school->academic_year_id,$subject_id);
            
            $this->data['exam_details'] = $this->mark->get_exam_details($school_id, $exam_id, $class_id, $school->academic_year_id,$subject_id);
