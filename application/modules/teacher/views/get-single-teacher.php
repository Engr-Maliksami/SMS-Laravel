    ...
    <br/>
     ...
     <div class="tab-content">
        <div  class="tab-pane fade in active" id="tab_basic_info" > 
            <table class="table table-striped table-bordered dt-responsive nowrap hideInMobileView" cellspacing="0" width="100%">
                <tbody>
                    <tr>
            ...
            <table class="table table-striped table-bordered dt-responsive nowrap viewInWebView" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                        <th width="20%"><?php echo $this->lang->line('school'); ?> <?php echo $this->lang->line('name'); ?></th>
                        <td width="30%"><?php echo $teacher->school_name; ?></td>        
                    ...
                    <tr>    <th width="20%"><?php echo $this->lang->line('username'); ?></th>
                        <td width="30%"><?php echo $teacher->username; ?></td>   </tr>
                    <tr>
                        <th><?php echo $this->lang->line('name'); ?></th>
                        <td><?php echo $teacher->name; ?></td>        
                    
                    </tr>
                    <tr>    <th><?php echo $this->lang->line('responsibility'); ?></th>
                        <td><?php echo $teacher->responsibility; ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('national_id'); ?></th>
                        <td><?php echo $teacher->national_id; ?></td>        
                     
                    </tr>
                    <tr>   <th><?php echo $this->lang->line('phone'); ?></th>
                        <td><?php echo $teacher->phone; ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('present'); ?> <?php echo $this->lang->line('address'); ?></th>
                        <td><?php echo $teacher->present_address; ?></td>        
                    
                    </tr>
                    <tr>    <th><?php echo $this->lang->line('permanent'); ?> <?php echo $this->lang->line('address'); ?></th>
                        <td><?php echo $teacher->permanent_address; ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('gender'); ?></th>
                        <td><?php echo $this->lang->line($teacher->gender); ?></td>        
                       
                    </tr>
                    <tr> <th><?php echo $this->lang->line('blood_group'); ?></th>
                        <td><?php echo $this->lang->line($teacher->blood_group); ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('religion'); ?></th>
                        <td><?php echo $teacher->religion; ?></td>        
                       
                    </tr>
                    <tr> <th><?php echo $this->lang->line('birth_date'); ?></th>
                        <td><?php echo date($this->global_setting->date_format, strtotime($teacher->dob)); ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('join_date'); ?></th>
                        <td><?php echo date($this->global_setting->date_format, strtotime($teacher->joining_date)); ?></td>        
                       
                    </tr>
                    <tr> <th><?php echo $this->lang->line('role'); ?></th>
                        <td><?php echo $teacher->role; ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('salary_grade'); ?></th>
                        <td><?php echo $teacher->grade_name; ?></td>        
                      
                    </tr>
                    <tr>  <th><?php echo $this->lang->line('salary_type'); ?></th>
                        <td><?php echo $this->lang->line($teacher->salary_type); ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('email'); ?></th>
                        <td><?php echo $teacher->email; ?></td>        
                        
                    </tr>
                    <tr><th><?php echo $this->lang->line('other_info'); ?></th>
                        <td><?php echo $teacher->other_info; ?></td></tr>
        ...
        <div  class="tab-pane fade in " id="tab_social_info" > 
            ...
            <table class="table table-striped table-bordered dt-responsive nowrap viewInWebView" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr> <th><?php echo $this->lang->line('linkedin_url'); ?></th>
                        <td><?php echo $teacher->linkedin_url; ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('twitter_url'); ?></th>
                        <td><?php echo $teacher->twitter_url; ?></td>        
                       
                    </tr>
                    <tr> <th><?php echo $this->lang->line('google_plus_url'); ?></th>
                        <td><?php echo $teacher->google_plus_url; ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('instagram_url'); ?></th>
                        <td><?php echo $teacher->instagram_url; ?></td>        
                     
                    </tr>
                    <tr>   <th><?php echo $this->lang->line('pinterest_url'); ?></th>
                        <td><?php echo $teacher->pinterest_url; ?></td></tr>
                    <tr>
                        <th><?php echo $this->lang->line('youtube_url'); ?></th>
                        <td><?php echo $teacher->youtube_url; ?></td>        
                       
                    </tr>
                    <tr> <th><?php echo $this->lang->line('is_view_on_web'); ?></th>
                        <td><?php echo $teacher->is_view_on_web ? $this->lang->line('yes') : $this->lang->line('no'); ?></td></tr>
                </tbody>
            </table>
        </div>
     </div>
