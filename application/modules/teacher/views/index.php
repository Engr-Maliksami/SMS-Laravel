                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_teacher_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('teacher'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        ...
                        <?php if (has_permission(ADD, 'teacher', 'teacher')) { ?>
                            ...
                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                        echo 'active';
                                                    } ?>"><a href="<?php echo site_url('teacher/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('teacher'); ?></a> </li>
                            <?php } else { ?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in <?php if (isset($list)) {
                            ...
                            <div class="x_content">
                                  <div class="row school-select-btn"><div class="col-md-10"></div><div class="col-md-2">
                                  <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) {  ?>
                                <select class="form-control col-md-7 col-xs-12 common" onchange="get_teacher_by_school(this.value);">
                                    <option value="<?php echo site_url('teacher/index/'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option>
                                    <?php foreach ($schools as $obj) { ?>
                                        <option value="<?php echo site_url('teacher/index/' . $obj->id); ?>" <?php if (isset($filter_school_id) && $filter_school_id == $obj->id) {
                                            ...
                                            <?php foreach ($teachers as $obj) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- sarvesh -->
                                                        <?php if ($obj->photo != '') { ?>
                                                            <img class="changeBorder" src="<?php echo UPLOAD_PATH; ?>/teacher-photo/<?php echo $obj->photo; ?>" alt="" width="70" />
                                                        <?php } else { ?>
                                                    ...
                                                    <td class="displayOneLine">
                                                        <?php if (has_permission(EDIT, 'teacher', 'teacher')) { ?>
                                                            <a href="<?php echo site_url('teacher/edit/' . $obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i> </a><br />
                                                        <?php } ?>
                                                        <?php if (has_permission(VIEW, 'teacher', 'teacher')) { ?>
                                                            <a onclick="get_teacher_modal(<?php echo $obj->id; ?>);" data-toggle="modal" data-target=".bs-teacher-modal-lg"><i class="changeFaColor fa fa-eye"></i> </a><br />
                                                        <?php } ?>
                                                        <?php if (has_permission(DELETE, 'teacher', 'teacher')) { ?>
                                                            <a href="<?php echo site_url('teacher/delete/' . $obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><i class="changeFaColor fa fa-trash-o"></i> </a>
                                                        <?php } ?>
                                                    </td>
                                                    <!-- sarvesh -->
                                                </tr>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-7 col-xs-12" name="responsibility" id="responsibility" value="<?php echo isset($post['responsibility']) ?  $post['responsibility'] : ''; ?>" placeholder="<?php echo $this->lang->line('responsibility'); ?>"  type="text" autocomplete="off">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="gender" id="gender" required="required">
                                                    ...
                                                    <?php foreach ($genders as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php if (isset($post['gender']) && $post['gender'] == $key) {
                                                                                                    echo 'selected="selected"';
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="blood_group" id="blood_group">
                                                    ...
                                                    <?php foreach ($bloods as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php if (isset($post['blood_group']) && $post['blood_group'] == $key) {
                                                                                                    echo 'selected="selected"';
                                                                                                } ?>><?php echo $value; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12 quick-field" name="salary_grade_id" id="add_salary_grade_id" required="required">
                                                ...
                                                <?php foreach ($grades as $obj) { ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php if (isset($post['salary_grade_id']) && $post['salary_grade_id'] == $obj->id) {
                                                                                                    echo 'selected="selected"';
                               ...
                               <div class="col-md-12 col-sm-12">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" name="salary_type" id="salary_type" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="monthly" <?php if (isset($post['salary_type']) && $post['salary_type'] == 'monthly') {
                                                                            echo 'selected="selected"';
                                                                        } ?>><?php echo $this->lang->line('monthly'); ?></option>
                                                <option value="hourly" <?php if (isset($post['salary_type']) && $post['salary_type'] == 'hourly') {
                                                                            echo 'selected="selected"';
                                                                        } ?>><?php echo $this->lang->line('hourly'); ?></option>
                                            </select>
                                            ...
                                            <select class="form-control col-md-7 col-xs-12 quick-field" name="role_id" id="role_id" required="required">
                                                <?php foreach ($roles as $obj) { ?>
                                                    <?php if (in_array($obj->id, array(TEACHER))) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if (isset($post['role_id']) && $post['role_id'] == $obj->id) {
                                                                                                            echo 'selected="selected"';
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="photo-details" id="resume_filename"></div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" name="is_view_on_web" id="is_view_on_web">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="1" <?php if (isset($post['is_view_on_web']) && $post['is_view_on_web'] == '1') {
                                                                        echo 'selected="selected"';
                                                                    } ?>><?php echo $this->lang->line('yes'); ?></option>
                                                <option value="0" <?php if (isset($post['is_view_on_web']) && $post['is_view_on_web'] == '0') {
                                                                        echo 'selected="selected"';
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="responsibility"><?php echo $this->lang->line('responsibility'); ?> </label>
                                                <input class="form-control col-md-7 col-xs-12" name="responsibility" id="responsibility" value="<?php echo isset($teacher->responsibility) ?  $teacher->responsibility : ''; ?>" placeholder="<?php echo $this->lang->line('responsibility'); ?>"  type="text" autocomplete="off">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="gender" id="gender" required="required">
                                                    ...
                                                    <?php $genders = get_genders(); ?>
                                                    <?php foreach ($genders as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php if ($teacher->gender == $key) {
                                                                                                        echo 'selected="selected"';
                                                                                                    } ?>><?php echo $value; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="blood_group" id="blood_group">
                                                    ...
                                                    <?php $bloods = get_blood_group(); ?>
                                                    <?php foreach ($bloods as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php if ($teacher->blood_group == $key) {
                                                                                                        echo 'selected="selected"';
                                                                                                    } ?>><?php echo $value; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12 quick-field" name="salary_grade_id" id="edit_salary_grade_id" required="required">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <?php foreach ($grades as $obj) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($teacher->salary_grade_id == $obj->id) {
                                                                                                            echo 'selected="selected"';
                                                                                                        } ?>><?php echo $obj->grade_name; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="salary_type" id="edit_salary_type" required="required">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <option value="monthly" <?php if ($teacher->salary_type == 'monthly') {
                                                                                    echo 'selected="selected"';
                                                                                } ?>><?php echo $this->lang->line('monthly'); ?></option>
                                                    <option value="hourly" <?php if ($teacher->salary_type == 'hourly') {
                                                                                    echo 'selected="selected"';
                                                                                } ?>><?php echo $this->lang->line('hourly'); ?></option>
                                                </select>
                                                <div class="help-block"><?php echo form_error('salary_type'); ?></div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12 quick-field" name="role_id" id="role_id" required="required">
                                                    ...
                                                    <?php foreach ($roles as $obj) { ?>
                                                        <?php if (in_array($obj->id, array(TEACHER))) { ?>
                                                            <option value="<?php echo $obj->id; ?>" <?php if ($teacher->role_id == $obj->id) {
                                                                                                                    echo 'selected="selected"';
                                                                                                                } ?>><?php echo $obj->name; ?></option>
                                                        <?php } ?>
                                                    <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="form-control col-md-7 col-xs-12" name="is_view_on_web" id="is_view_on_web">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <option value="1" <?php if ($teacher->is_view_on_web == 1) {
                                                                                echo 'selected="selected"';
                                                                            } ?>><?php echo $this->lang->line('yes'); ?></option>
                                                    <option value="0" <?php if ($teacher->is_view_on_web == 0) {
                                                                                echo 'selected="selected"';
                                                                            } ?>><?php echo $this->lang->line('no'); ?></option>
                                                </select>
                                                <div class="help-block"><?php echo form_error('is_view_on_web'); ?></div>
...
<script type="text/javascript">
       ...
       $("#resume").change(function(){
            ...
            $('#resume_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Teacher",
                    text: "Resume  "+ input.files[0].name+ " selected",
                    type: "success",
         ...
         $("#photo").change(function(){
            ...
            $('#photo_filename').html('File name: ' + input.files[0].name);
                swal({
                    title: "Teacher",
                    text: "Photo  "+ input.files[0].name+ " selected",
                    type: "success",
                    confirmButtonText: "OK"
                });
         });
