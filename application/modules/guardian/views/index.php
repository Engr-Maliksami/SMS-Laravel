                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_guardian_list" >
                            ...
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_guardian_by_school(this.value);">
                                        <option value="<?php echo site_url('guardian/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($guardians) && !empty($guardians)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php  if($obj->photo != ''){ ?>
                                                <img class="changeBorder" src="<?php echo UPLOAD_PATH; ?>/guardian-photo/<?php echo $obj->photo; ?>" alt="" width="70" /> 
                                                <?php }else{ ?>
                                            ...
                                            <td class="displayOneLine">
                                                <?php if(has_permission(EDIT, 'guardian', 'guardian')){ ?>
                                                    <a href="<?php echo site_url('guardian/edit/'.$obj->id); ?>"><i class="changeFaColor fa fa-pencil-square-o"></i> </a><br/>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'guardian', 'guardian')){ ?>
                                                    <a  onclick="get_guardian_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-guardian-modal-lg" ><i class="changeFaColor fa fa-eye"></i> </a><br/>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'guardian', 'guardian')){ ?>
                                                    <a href="<?php echo site_url('guardian/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="changeFaColor fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
