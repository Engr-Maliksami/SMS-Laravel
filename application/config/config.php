...
//$config['base_url'] =  'http://192.168.1.151/SMS';
	/** vipul set base url like below **/	
...
define('TCPDF', $config['base_url'] . '/application/modules/api/tcpdf/');
...
define('SMS', 'School Management System');
define('FROM_EMAIL', 'info@bitibe.com');
