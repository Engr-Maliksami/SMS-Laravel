...
--
-- Host: localhost:3306
-- Generation Time: Jan 07, 2020 at 07:34 PM
...
INSERT INTO `email_settings` (`id`, `school_id`, `mail_protocol`, `smtp_host`, `smtp_port`, `smtp_timeout`, `smtp_user`, `smtp_pass`, `smtp_crypto`, `mail_type`, `char_set`, `priority`, `from_name`, `from_address`, `status`, `created_at`, `modified_at`, `created_by`, `modified_by`) VALUES
(1, 1, 'smtp', 'smtp.gmail.com', '465', 10, 'dharmendrapkukreja@gmail.com', 'gfdfg', 'ssl', 'html', 'utf-8', 1, 'Dharmendra Kukreja', 'dharmendrapkukreja@gmail.com', 1, '2019-12-13 18:50:47', '0000-00-00 00:00:00', 1, 0);
...
--
-- Table structure for table `exam_type_mapping`
--

CREATE TABLE `exam_type_mapping` (
  `id` int(11) NOT NULL,
  `exam_id` int(11) NOT NULL,
  `exam_type_id` int(11) NOT NULL,
  `max_marks` int(6) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `class_id` int(11) NOT NULL,
  `academic_year_id` int(11) NOT NULL
...
CREATE TABLE `global_setting` (
  ...
  `base_url_server` varchar(255) NOT NULL,
  `status` tinyint(1) NOT NULL,
  `created_by` int(11) NOT NULL,
  `modified_by` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
...
INSERT INTO `global_setting` (`id`, `brand_name`, `brand_title`, `language`, `enable_rtl`, `enable_frontend`, `theme_name`, `date_format`, `time_zone`, `brand_logo`, `favicon_icon`, `brand_footer`, `google_analytics`, `user_id`, `base_url_server`, `status`, `created_by`, `modified_by`, `created_at`, `modified_at`) VALUES
(1, 'Multi School', 'Global - Multi School Management System Express', 'hindi', 0, 1, 'radical-red', 'j M, Y', 'Asia/Dhaka', '1567887984-brand-logo.png', '1567888028-favicon-icon.png', 'Copyright © Global - Multi School Management System Express at 2020', '', 7, 'http://diflip.com/', 1, 1, 1, '2018-10-02 10:39:15', '2020-01-07 17:00:15');
...
--
-- Table structure for table `holidays_dates`
--

CREATE TABLE `holidays_dates` (
  `id` int(11) NOT NULL,
...
INSERT INTO `id_card_settings` (`id`, `school_id`, `border_color`, `top_bg`, `bottom_bg`, `school_logo`, `school_name`, `school_name_font_size`, `school_name_color`, `school_address`, `school_address_color`, `id_no_font_size`, `id_no_color`, `id_no_bg`, `title_font_size`, `title_color`, `value_font_size`, `value_color`, `bottom_text`, `bottom_text_color`, `bottom_text_align`, `status`, `created_at`, `modified_at`, `created_by`, `modified_by`) VALUES
(1, 1, '#dc5113', 'rgb(0,0,128)', '#1ae03c', '1575639693-id-logo.png', 'Wilson', '14', '#dae01a', 'Vijay Nagar', '#abe01a', '12', '#34e01a', '#e01a9b', '12', '#e0281a', '12', '#1ae0b2', 'No signature required', '#e0281a', 'center', 1, '2019-12-06 19:41:33', '2019-12-18 18:10:47', 1, 1);
...
CREATE TABLE `marks_details` (
  ...
  `marks_obtained` varchar(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `master_exam_types`
--

CREATE TABLE `master_exam_types` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `master_exam_types`
--

INSERT INTO `master_exam_types` (`id`, `name`, `visible`) VALUES
(1, 'Practical', 1),
(2, 'Written', 1),
(3, 'Viva', 1),
(4, 'Musical', 1),
...
--
-- Table structure for table `max_participant_allowed`
--

CREATE TABLE `max_participant_allowed` (
  `id` int(255) NOT NULL,
  `school_id` int(20) NOT NULL,
  `students_allowed` int(20) NOT NULL,
  `teachers_allowed` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `max_participant_allowed`
--

INSERT INTO `max_participant_allowed` (`id`, `school_id`, `students_allowed`, `teachers_allowed`) VALUES
(1, 1, 8, 3);
...
(1, 1, NULL, NULL, NULL, '', 1, 0.00, 0, NULL, NULL, NULL, NULL, '', '', 1, 0.00, 0, NULL, NULL, NULL, NULL, NULL, '', '', '', '', 1, 0.00, 0, 'sk_test_491c2c692dcf86804f118ea3e08142cb092f28be', 'pk_test_3eb2a25774524e4bd9208ef18eb7fc842e7effa4', 1, '0.00', 1, 1, '2019-12-19 11:30:13', '0000-00-00 00:00:00', 1, 0);
...
(0, '9167cfef-2c52-45f8-a99d-2f6e0fe0d5fd', 1, '2019-11-08 17:46:01', '0000-00-00 00:00:00', 1, 0);
...
CREATE TABLE `route_stops` (
  ...
  `stop_fare` double(10,2) DEFAULT NULL,
  `stop_lat` varchar(50) NOT NULL,
  `stop_long` varchar(50) NOT NULL,
  `status` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `modified_at` datetime NOT NULL,
  `created_by` int(11) NOT NULL,
...
INSERT INTO `schools` (`id`, `school_name`, `school_code`, `registration_date`, `address`, `phone`, `email`, `currency`, `currency_symbol`, `footer`, `logo`, `frontend_logo`, `academic_year_id`, `academic_year`, `school_fax`, `school_lat`, `school_lng`, `map_api_key`, `enable_frontend`, `enable_online_admission`, `final_result_type`, `theme_name`, `about_text`, `about_image`, `facebook_url`, `twitter_url`, `linkedin_url`, `google_plus_url`, `youtube_url`, `instagram_url`, `pinterest_url`, `status`, `created_at`, `modified_at`, `created_by`, `modified_by`) VALUES
(1, 'Windsor Park High School', 'ASD23CR', '01-03-1907', '10433 Wolverine Way  Bellevue, CA 98456', '0123456789', 'info@gsms.com', 'USD', '$', 'Copyright © Windsor Park High School 2020', '1567742059-school-logo.png', '1567742059-school-front-logo.png', 1, '2019 - 2020', '25435345', '23.77', '90.399452', '', 1, 1, 0, 'jazzberry-jam', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.', '', 'https://www.facebook.com/', 'https://www.twitter.com/', 'https://www.linkedin.com/', 'https://plus.google.com/', 'https://www.youtube.com/', 'https://www.instagram.com/', 'https://www.pinterest.com/', 1, '2017-08-23 09:40:28', '2020-01-07 17:04:41', 1, 1);
...
CREATE TABLE `student_attendances` (
  ...
  `month` varchar(10) NOT NULL,
  `year` varchar(10) NOT NULL,
  `day_1` varchar(25) DEFAULT NULL,
  `day_2` varchar(25) DEFAULT NULL,
  `day_3` varchar(25) DEFAULT NULL,
  `day_4` varchar(25) DEFAULT NULL,
  `day_5` varchar(25) DEFAULT NULL,
  `day_6` varchar(25) DEFAULT NULL,
  `day_7` varchar(25) DEFAULT NULL,
  `day_8` varchar(25) DEFAULT NULL,
  `day_9` varchar(25) DEFAULT NULL,
  `day_10` varchar(25) DEFAULT NULL,
  `day_11` varchar(25) DEFAULT NULL,
  `day_12` varchar(25) DEFAULT NULL,
  `day_13` varchar(25) DEFAULT NULL,
  `day_14` varchar(25) DEFAULT NULL,
  `day_15` varchar(25) DEFAULT NULL,
  `day_16` varchar(25) DEFAULT NULL,
  `day_17` varchar(25) DEFAULT NULL,
  `day_18` varchar(25) DEFAULT NULL,
  `day_19` varchar(25) DEFAULT NULL,
  `day_20` varchar(25) DEFAULT NULL,
  `day_21` varchar(25) DEFAULT NULL,
  `day_22` varchar(25) DEFAULT NULL,
  `day_23` varchar(25) DEFAULT NULL,
  `day_24` varchar(25) DEFAULT NULL,
  `day_25` varchar(25) DEFAULT NULL,
  `day_26` varchar(25) DEFAULT NULL,
  `day_27` varchar(25) DEFAULT NULL,
  `day_28` varchar(25) DEFAULT NULL,
  `day_29` varchar(25) DEFAULT NULL,
  `day_30` varchar(25) DEFAULT NULL,
  `day_31` varchar(25) DEFAULT NULL,
  `status` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `modified_at` datetime NOT NULL,
  `created_by` int(11) NOT NULL,
...
INSERT INTO `student_types` (`id`, `school_id`, `type`, `note`, `status`, `created_at`, `modified_at`, `created_by`, `modified_by`) VALUES
(1, 1, 'Regular', '', 1, '2019-11-11 15:57:11', '0000-00-00 00:00:00', 1, 0);
...
INSERT INTO `system_admin` (`id`, `user_id`, `is_default`, `national_id`, `name`, `email`, `phone`, `present_address`, `permanent_address`, `gender`, `blood_group`, `religion`, `dob`, `photo`, `resume`, `other_info`, `status`, `created_at`, `modified_at`, `created_by`, `modified_by`) VALUES
(1, 1, 1, '123456789', 'Super Admin', 'superadmin@gmsms.com', '123456789', '6160 Peachtree Dunwoody Rd Suite B100-A', '6160 Peachtree Dunwoody Rd Suite B100-A', 'male', 'b_positive', '', '1985-01-01', '', '', '', 1, '0000-00-00 00:00:00', '2019-09-08 02:17:48', 0, 1);
...
(1, 1, 0, 'e10adc3949ba59abbe56e057f20f883e', 'MTIzNDU2', 'superadmin', NULL, 1, '2020-01-07 19:04:58', '2013-11-15 20:33:03', '2018-11-30 14:13:42', 0, 1);
...
--
-- Indexes for table `exam_type_mapping`
--
ALTER TABLE `exam_type_mapping`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `holidays_dates`
--
ALTER TABLE `holidays_dates`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `master_exam_types`
--
ALTER TABLE `master_exam_types`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `max_participant_allowed`
--
ALTER TABLE `max_participant_allowed`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `exam_schedules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `exam_type_mapping`
--
ALTER TABLE `exam_type_mapping`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `holidays`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `holidays_dates`
--
ALTER TABLE `holidays_dates`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `mark_smses`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `master_exam_types`
--
ALTER TABLE `master_exam_types`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `max_participant_allowed`
--
ALTER TABLE `max_participant_allowed`
