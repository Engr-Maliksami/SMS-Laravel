    ...
    {!! getValidationMessage('password')!!}
        ...
        <div class="input-group">
              ...
              <div class="col-md-12 form-group{{ $errors->has('g-recaptcha-response') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 pull-center" style="margin-left: 85px;">
                                {!! app('captcha')->display() !!}
      ...
      <div class="text-center buttons">
        ...
        <button type="submit" class="btn button btn-success btn-lg" ng-disabled='!loginForm.$valid' style="margin-top: -25px;">{{getPhrase('login')}}</button>
